function t(t, e) {
    if (e < t[0])
        return console.warn("bisectionSearch: requested value below lowest array element. Returning undefined."), {index: void 0, mu: void 0};
    let n = 0,
        i = t.length;
    for (; i > n + 1; ) {
        let r = Math.floor(0.5 * (n + i));
        if (t[r] === e) return {index: r, mu: 0};
        t[r] < e ? (n = r) : (i = r);
    }
    let r = (e - t[n]) / (t[n + 1] - t[n]);
    return (
        n === t.length - 1 && (console.warn("bisectionSearch: Reached end of array. Simple interpolation will result in NaN."), (r = void 0)),
        {index: n, mu: r}
    );
}
function e(t, e, n = 0.5) {
    return isNaN(t) ? e : isNaN(e) ? t : (1 - n) * t + n * e;
}
const n = 0,
    i = 1,
    r = 2,
...
const en = {
    ...
    damp: function (t, e, n, i) {
        return en.lerp(t, e, 1 - Math.exp(-n * i));
    },
    pingpong: function (t, e = 1) {
        return e - Math.abs(en.euclideanModulo(t, 2 * e) - e);
    },
    ...
    seededRandom: function (t) {
        return void 0 !== t && (tn = t % 2147483647), (tn = (16807 * tn) % 2147483647), (tn - 1) / 2147483646;
    },
    degToRad: function (t) {
        return t * en.DEG2RAD;
    },
...
const an = {
    getDataURL: function (t) {
        ...
        if (t instanceof HTMLCanvasElement) e = t;
            ...
            void 0 === sn && (sn = document.createElementNS("http://www.w3.org/1999/xhtml", "canvas")), (sn.width = t.width), (sn.height = t.height);
...
let on = 0;
class ln extends Ke {
    constructor(t = ln.DEFAULT_IMAGE, e = ln.DEFAULT_MAPPING, n = ht, i = ht, r = mt, s = vt, a = Dt, o = yt, l = 1, c = ze) {
        super(),
    ...
    toJSON(t) {
        ...
        if (void 0 !== this.image) {
            const i = this.image;
            if ((void 0 === i.uuid && (i.uuid = en.generateUUID()), !e && void 0 === t.images[i.uuid])) {
                let e;
                if (Array.isArray(i)) {
                    e = [];
...
(ln.DEFAULT_IMAGE = void 0), (ln.DEFAULT_MAPPING = 300), (ln.prototype.isTexture = !0);
class hn {
...
class un extends Ke {
    constructor(t, e, n) {
        super(),
            ...
            (n = n || {}),
            (this.texture = new ln(void 0, n.mapping, n.wrapS, n.wrapT, n.magFilter, n.minFilter, n.format, n.type, n.anisotropy, n.encoding)),
            (this.texture.image = {}),
...
class dn {
    ...
    angleTo(t) {
        return 2 * Math.acos(Math.abs(en.clamp(this.dot(t), -1, 1)));
    }
    rotateTowards(t, e) {
...
class pn {
    ...
    projectOnPlane(t) {
        return fn.copy(this).projectOnVector(t), this.sub(fn);
    }
    reflect(t) {
        return this.sub(fn.copy(t).multiplyScalar(2 * this.dot(t)));
    }
    angleTo(t) {
        const e = Math.sqrt(this.lengthSq() * t.lengthSq());
        if (0 === e) return Math.PI / 2;
        const n = this.dot(t) / e;
        return Math.acos(en.clamp(n, -1, 1));
    }
    distanceTo(t) {
        return Math.sqrt(this.distanceToSquared(t));
    }
...
const fn = new pn(),
    mn = new dn();
class gn {
    constructor(t = new pn(1 / 0, 1 / 0, 1 / 0), e = new pn(-1 / 0, -1 / 0, -1 / 0)) {
    ...
    getCenter(t) {
        return (
            void 0 === t && (console.warn("THREE.Box3: .getCenter() target is now required"), (t = new pn())),
            this.isEmpty() ? t.set(0, 0, 0) : t.addVectors(this.min, this.max).multiplyScalar(0.5)
        );
    }
    getSize(t) {
        return (
            void 0 === t && (console.warn("THREE.Box3: .getSize() target is now required"), (t = new pn())),
    ...
    expandByObject(t) {
        ...
        const e = t.geometry;
        void 0 !== e && (null === e.boundingBox && e.computeBoundingBox(), xn.copy(e.boundingBox), xn.applyMatrix4(t.matrixWorld), this.union(xn));
        const n = t.children;
    ...
    getParameter(t, e) {
        return (
            void 0 === e && (console.warn("THREE.Box3: .getParameter() target is now required"), (e = new pn())),
            e.set(
    ...
    intersectsTriangle(t) {
        ...
        this.getCenter(Tn),
            Ln.subVectors(this.max, Tn),
            _n.subVectors(t.a, Tn),
            bn.subVectors(t.b, Tn),
            wn.subVectors(t.c, Tn),
            Mn.subVectors(bn, _n),
            Sn.subVectors(wn, bn),
            En.subVectors(_n, wn);
        let e = [
        ...
        return (
            !!Cn(e, _n, bn, wn, Ln) &&
            ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !!Cn(e, _n, bn, wn, Ln) && (An.crossVectors(Mn, Sn), (e = [An.x, An.y, An.z]), Cn(e, _n, bn, wn, Ln)))
        );
    }
    clampPoint(t, e) {
        return (
            void 0 === e && (console.warn("THREE.Box3: .clampPoint() target is now required"), (e = new pn())), e.copy(t).clamp(this.min, this.max)
        );
    }
    distanceToPoint(t) {
    ...
    applyMatrix4(t) {
        return (
            this.isEmpty() ||
                (vn[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(t),
...
function Cn(t, e, n, i, r) {
    for (let s = 0, a = t.length - 3; s <= a; s += 3) {
        Rn.fromArray(t, s);
        const a = r.x * Math.abs(Rn.x) + r.y * Math.abs(Rn.y) + r.z * Math.abs(Rn.z),
            o = e.dot(Rn),
            l = n.dot(Rn),
            c = i.dot(Rn);
...
class Dn {
    ...
    clampPoint(t, e) {
        ...
        return (
            void 0 === e && (console.warn("THREE.Sphere: .clampPoint() target is now required"), (e = new pn())),
            e.copy(t),
    ...
    getBoundingBox(t) {
        return (
            void 0 === t && (console.warn("THREE.Sphere: .getBoundingBox() target is now required"), (t = new gn())),
...
const Nn = new pn(),
    ...
    Fn = new pn();
class Un {
    constructor(t = new pn(), e = new pn(0, 0, -1)) {
    ...
    at(t, e) {
        return (
            void 0 === e && (console.warn("THREE.Ray: .at() target is now required"), (e = new pn())),
    ...
    closestPointToPoint(t, e) {
        void 0 === e && (console.warn("THREE.Ray: .closestPointToPoint() target is now required"), (e = new pn())), e.subVectors(t, this.origin);
    ...
    distanceSqToPoint(t) {
        ...
        return e < 0 ? this.origin.distanceToSquared(t) : (Nn.copy(this.direction).multiplyScalar(e).add(this.origin), Nn.distanceToSquared(t));
    }
    distanceSqToSegment(t, e, n, i) {
        In.copy(t).add(e).multiplyScalar(0.5), On.copy(e).sub(t).normalize(), zn.copy(this.origin).sub(In);
        const r = 0.5 * t.distanceTo(e),
            s = -this.direction.dot(On),
            a = zn.dot(this.direction),
            o = -zn.dot(On),
            l = zn.lengthSq(),
            c = Math.abs(1 - s * s);
        let h, u, d, p;
        ...
        return n && n.copy(this.direction).multiplyScalar(h).add(this.origin), i && i.copy(On).multiplyScalar(u).add(In), d;
    }
    intersectSphere(t, e) {
    ...
    intersectTriangle(t, e, n, i, r) {
        Hn.subVectors(e, t), Bn.subVectors(n, t), Fn.crossVectors(Hn, Bn);
        let s,
        ...
        const o = s * this.direction.dot(Bn.crossVectors(zn, Bn));
        if (o < 0) return null;
        const l = s * this.direction.dot(Hn.cross(zn));
        if (l < 0) return null;
...
class Gn {
    ...
    extractRotation(t) {
        const e = this.elements,
            n = t.elements,
            i = 1 / kn.setFromMatrixColumn(t, 0).length(),
            r = 1 / kn.setFromMatrixColumn(t, 1).length(),
            s = 1 / kn.setFromMatrixColumn(t, 2).length();
        return (
            (e[0] = n[0] * i),
            (e[1] = n[1] * i),
            (e[2] = n[2] * i),
    ...
    lookAt(t, e, n) {
        ...
        return (
            ...
            Yn.normalize(),
            qn.crossVectors(n, Yn),
            0 === qn.lengthSq() && (1 === Math.abs(n.z) ? (Yn.x += 1e-4) : (Yn.z += 1e-4), Yn.normalize(), qn.crossVectors(n, Yn)),
            qn.normalize(),
            Xn.crossVectors(Yn, qn),
            (i[0] = qn.x),
            (i[4] = Xn.x),
            (i[8] = Yn.x),
            (i[1] = qn.y),
    ...
    multiplyMatrices(t, e) {
        ...
        return (
            ...
            (r[2] = p * b + f * E + m * R + g * N),
            (r[6] = p * w + f * T + m * C + g * I),
            (r[10] = p * M + f * L + m * P + g * O),
            (r[14] = p * S + f * A + m * D + g * z),
            (r[3] = v * b + y * E + x * R + _ * N),
            (r[7] = v * w + y * T + x * C + _ * I),
            (r[11] = v * M + y * L + x * P + _ * O),
    ...
    decompose(t, e, n) {
        ...
        const s = kn.set(i[4], i[5], i[6]).length(),
            a = kn.set(i[8], i[9], i[10]).length();
...
const kn = new pn(),
    ...
    Jn = new dn();
class Qn {
    constructor(t = 0, e = 0, n = 0, i = Qn.DefaultOrder) {
    ...
    setFromQuaternion(t, e, n) {
        return Zn.makeRotationFromQuaternion(t), this.setFromRotationMatrix(Zn, e, n);
    }
    setFromVector3(t, e) {
        return this.set(t.x, t.y, t.z, e || this._order);
    }
    reorder(t) {
        return Jn.setFromEuler(this), this.setFromQuaternion(Jn, t);
    }
    equals(t) {
    ...
    toVector3(t) {
        return t ? t.set(this._x, this._y, this._z) : new pn(this._x, this._y, this._z);
    }
    _onChange(t) {
        return (this._onChangeCallback = t), this;
    }
...
(Qn.prototype.isEuler = !0), (Qn.DefaultOrder = "XYZ"), (Qn.RotationOrders = ["XYZ", "YZX", "ZXY", "XZY", "YXZ", "ZYX"]);
class Kn {
    constructor() {
        this.mask = 1;
    }
...
function di() {
    ...
    e._onChange(function () {
        ...
        Object.defineProperties(this, {
            ...
            modelViewMatrix: {value: new Gn()},
            normalMatrix: {value: new rn()},
        }),
        (this.matrix = new Gn()),
        (this.matrixWorld = new Gn()),
        (this.matrixAutoUpdate = di.DefaultMatrixAutoUpdate),
...
(di.DefaultUp = new pn(0, 1, 0)),
    (di.DefaultMatrixAutoUpdate = !0),
    (di.prototype = Object.assign(Object.create(Ke.prototype), {
        constructor: di,
        isObject3D: !0,
        ...
        translateOnAxis: function (t, e) {
            return ti.copy(t).applyQuaternion(this.quaternion), this.position.add(ti.multiplyScalar(e)), this;
        },
        ...
        worldToLocal: function (t) {
            return t.applyMatrix4(ni.copy(this.matrixWorld).invert());
        },
        lookAt: function (t, e, n) {
            t.isVector3 ? ii.copy(t) : ii.set(t, e, n);
            const i = this.parent;
            this.updateWorldMatrix(!0, !1),
                ri.setFromMatrixPosition(this.matrixWorld),
                this.isCamera || this.isLight ? ni.lookAt(ri, ii, this.up) : ni.lookAt(ii, ri, this.up),
                this.quaternion.setFromRotationMatrix(ni),
                i && (ni.extractRotation(i.matrixWorld), ei.setFromRotationMatrix(ni), this.quaternion.premultiply(ei.invert()));
        },
        add: function (t) {
            ...
            return t === this
                ...
                : (t && t.isObject3D
                      ? (null !== t.parent && t.parent.remove(t), (t.parent = this), this.children.push(t), t.dispatchEvent(hi))
        ...
        remove: function (t) {
            ...
            return -1 !== e && ((t.parent = null), this.children.splice(e, 1), t.dispatchEvent(ui)), this;
        },
        clear: function () {
        ...
        attach: function (t) {
            return (
                ...
                null !== t.parent && (t.parent.updateWorldMatrix(!0, !1), ni.multiply(t.parent.matrixWorld)),
                t.applyMatrix4(ni),
                this.add(t),
        ...
        getWorldPosition: function (t) {
            return (
                void 0 === t && (console.warn("THREE.Object3D: .getWorldPosition() target is now required"), (t = new pn())),
                this.updateWorldMatrix(!0, !1),
        ...
        getWorldQuaternion: function (t) {
            return (
                void 0 === t && (console.warn("THREE.Object3D: .getWorldQuaternion() target is now required"), (t = new dn())),
                this.updateWorldMatrix(!0, !1),
                this.matrixWorld.decompose(ri, t, si),
                t
            );
        },
        getWorldScale: function (t) {
            return (
                void 0 === t && (console.warn("THREE.Object3D: .getWorldScale() target is now required"), (t = new pn())),
                this.updateWorldMatrix(!0, !1),
                this.matrixWorld.decompose(ri, ai, t),
                t
            );
        },
        getWorldDirection: function (t) {
            void 0 === t && (console.warn("THREE.Object3D: .getWorldDirection() target is now required"), (t = new pn())),
                this.updateWorldMatrix(!0, !1);
...
const pi = new pn(),
    ...
    mi = new rn();
class gi {
    constructor(t = new pn(1, 0, 0), e = 0) {
    ...
    setFromCoplanarPoints(t, e, n) {
        const i = pi.subVectors(n, e).cross(fi.subVectors(t, e)).normalize();
    ...
    projectPoint(t, e) {
        return (
            void 0 === e && (console.warn("THREE.Plane: .projectPoint() target is now required"), (e = new pn())),
            e.copy(this.normal).multiplyScalar(-this.distanceToPoint(t)).add(t)
        );
    }
    intersectLine(t, e) {
        void 0 === e && (console.warn("THREE.Plane: .intersectLine() target is now required"), (e = new pn()));
        const n = t.delta(pi),
            i = this.normal.dot(n);
    ...
    coplanarPoint(t) {
        return (
            void 0 === t && (console.warn("THREE.Plane: .coplanarPoint() target is now required"), (t = new pn())),
            t.copy(this.normal).multiplyScalar(-this.constant)
        );
    }
    applyMatrix4(t, e) {
        const n = e || mi.getNormalMatrix(t),
            i = this.coplanarPoint(pi).applyMatrix4(t),
...
const vi = new pn(),
    ...
    Ti = new pn();
class Li {
    constructor(t = new pn(), e = new pn(), n = new pn()) {
        (this.a = t), (this.b = e), (this.c = n);
    }
    static getNormal(t, e, n, i) {
        void 0 === i && (console.warn("THREE.Triangle: .getNormal() target is now required"), (i = new pn())),
            i.subVectors(n, e),
            vi.subVectors(t, e),
            i.cross(vi);
        const r = i.lengthSq();
    ...
    static getBarycoord(t, e, n, i, r) {
        vi.subVectors(i, e), yi.subVectors(n, e), xi.subVectors(t, e);
        const s = vi.dot(vi),
            a = vi.dot(yi),
            o = vi.dot(xi),
            l = yi.dot(yi),
            c = yi.dot(xi),
            h = s * l - a * a;
        if ((void 0 === r && (console.warn("THREE.Triangle: .getBarycoord() target is now required"), (r = new pn())), 0 === h))
            return r.set(-2, -1, -1);
        const u = 1 / h,
            d = (l * o - a * c) * u,
            p = (s * c - a * o) * u;
    ...
    static containsPoint(t, e, n, i) {
        return this.getBarycoord(t, e, n, i, _i), _i.x >= 0 && _i.y >= 0 && _i.x + _i.y <= 1;
    }
    static getUV(t, e, n, i, r, s, a, o) {
        return this.getBarycoord(t, e, n, i, _i), o.set(0, 0), o.addScaledVector(r, _i.x), o.addScaledVector(s, _i.y), o.addScaledVector(a, _i.z), o;
    }
    static isFrontFacing(t, e, n, i) {
        return vi.subVectors(n, e), yi.subVectors(t, e), vi.cross(yi).dot(i) < 0;
    }
    set(t, e, n) {
    ...
    getArea() {
        return vi.subVectors(this.c, this.b), yi.subVectors(this.a, this.b), 0.5 * vi.cross(yi).length();
    }
    getMidpoint(t) {
        return (
            void 0 === t && (console.warn("THREE.Triangle: .getMidpoint() target is now required"), (t = new pn())),
            t
    ...
    getPlane(t) {
        return (
            void 0 === t && (console.warn("THREE.Triangle: .getPlane() target is now required"), (t = new gi())),
    ...
    closestPointToPoint(t, e) {
        void 0 === e && (console.warn("THREE.Triangle: .closestPointToPoint() target is now required"), (e = new pn()));
        const n = this.a,
            i = this.b,
            r = this.c;
        let s, a;
        bi.subVectors(i, n), wi.subVectors(r, n), Si.subVectors(t, n);
        const o = bi.dot(Si),
            l = wi.dot(Si);
        ...
        const u = o * h - c * l;
        if (u <= 0 && o >= 0 && c <= 0) return (s = o / (o - c)), e.copy(n).addScaledVector(bi, s);
        Ti.subVectors(t, r);
        const d = bi.dot(Ti),
            p = wi.dot(Ti);
        if (p >= 0 && d <= p) return e.copy(r);
        const f = d * l - o * p;
        if (f <= 0 && l >= 0 && p <= 0) return (a = l / (l - p)), e.copy(n).addScaledVector(wi, a);
        const m = c * p - d * h;
        if (m <= 0 && h - c >= 0 && d - p >= 0) return Mi.subVectors(r, i), (a = (h - c) / (h - c + (d - p))), e.copy(i).addScaledVector(Mi, a);
        const g = 1 / (m + f + u);
        return (s = f * g), (a = u * g), e.copy(n).addScaledVector(bi, s).addScaledVector(wi, a);
    }
    equals(t) {
...
(Ri.prototype = Object.assign(Object.create(Ke.prototype), {
    constructor: Ri,
    isMaterial: !0,
...
class zi {
    ...
    setHSL(t, e, n) {
        if (((t = en.euclideanModulo(t, 1)), (e = en.clamp(e, 0, 1)), (n = en.clamp(n, 0, 1)), 0 === e)) this.r = this.g = this.b = n;
        else {
    ...
    offsetHSL(t, e, n) {
        return this.getHSL(Pi), (Pi.h += t), (Pi.s += e), (Pi.l += n), this.setHSL(Pi.h, Pi.s, Pi.l), this;
    }
    add(t) {
        return (this.r += t.r), (this.g += t.g), (this.b += t.b), this;
    }
    ...
    lerpHSL(t, e) {
        this.getHSL(Pi), t.getHSL(Di);
        const n = en.lerp(Pi.h, Di.h, e),
            i = en.lerp(Pi.s, Di.s, e),
            r = en.lerp(Pi.l, Di.l, e);
...
(zi.NAMES = Ci), (zi.prototype.isColor = !0), (zi.prototype.r = 1), (zi.prototype.g = 1), (zi.prototype.b = 1);
class Hi extends Ri {
    constructor(t) {
        super(),
...
function Gi(t, e, n) {
    Ui.call(this, new Int8Array(t), e, n);
}
function ki(t, e, n) {
    Ui.call(this, new Uint8Array(t), e, n);
}
function Vi(t, e, n) {
    Ui.call(this, new Uint8ClampedArray(t), e, n);
}
function Wi(t, e, n) {
    Ui.call(this, new Int16Array(t), e, n);
}
function ji(t, e, n) {
    Ui.call(this, new Uint16Array(t), e, n);
}
function qi(t, e, n) {
    Ui.call(this, new Int32Array(t), e, n);
}
function Xi(t, e, n) {
    Ui.call(this, new Uint32Array(t), e, n);
}
function Yi(t, e, n) {
    Ui.call(this, new Uint16Array(t), e, n);
}
function Zi(t, e, n) {
    Ui.call(this, new Float32Array(t), e, n);
}
function Ji(t, e, n) {
    Ui.call(this, new Float64Array(t), e, n);
}
function Qi(t) {
...
Object.defineProperty(Ui.prototype, "needsUpdate", {
    ...
    Object.assign(Ui.prototype, {
        ...
        copyColorsArray: function (t) {
            ...
            for (let i = 0, r = t.length; i < r; i++) {
                let r = t[i];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyColorsArray(): color is undefined", i), (r = new zi())),
                    (e[n++] = r.r),
                    (e[n++] = r.g),
                    (e[n++] = r.b);
            }
        ...
        copyVector2sArray: function (t) {
            ...
            for (let i = 0, r = t.length; i < r; i++) {
                let r = t[i];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector2sArray(): vector is undefined", i), (r = new nn())),
                    (e[n++] = r.x),
                    (e[n++] = r.y);
            }
            return this;
        ...
        copyVector3sArray: function (t) {
            ...
            for (let i = 0, r = t.length; i < r; i++) {
                let r = t[i];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector3sArray(): vector is undefined", i), (r = new pn())),
                    (e[n++] = r.x),
                    (e[n++] = r.y),
                    (e[n++] = r.z);
            }
        ...
        copyVector4sArray: function (t) {
            ...
            for (let i = 0, r = t.length; i < r; i++) {
                let r = t[i];
                void 0 === r && (console.warn("THREE.BufferAttribute.copyVector4sArray(): vector is undefined", i), (r = new hn())),
                    (e[n++] = r.x),
                    (e[n++] = r.y),
                    (e[n++] = r.z),
                    (e[n++] = r.w);
        ...
        applyMatrix3: function (t) {
            if (2 === this.itemSize)
                for (let e = 0, n = this.count; e < n; e++) Fi.fromBufferAttribute(this, e), Fi.applyMatrix3(t), this.setXY(e, Fi.x, Fi.y);
            else if (3 === this.itemSize)
                for (let e = 0, n = this.count; e < n; e++) Bi.fromBufferAttribute(this, e), Bi.applyMatrix3(t), this.setXYZ(e, Bi.x, Bi.y, Bi.z);
            return this;
        },
        applyMatrix4: function (t) {
            for (let e = 0, n = this.count; e < n; e++)
                (Bi.x = this.getX(e)), (Bi.y = this.getY(e)), (Bi.z = this.getZ(e)), Bi.applyMatrix4(t), this.setXYZ(e, Bi.x, Bi.y, Bi.z);
            return this;
        },
        applyNormalMatrix: function (t) {
            for (let e = 0, n = this.count; e < n; e++)
                (Bi.x = this.getX(e)), (Bi.y = this.getY(e)), (Bi.z = this.getZ(e)), Bi.applyNormalMatrix(t), this.setXYZ(e, Bi.x, Bi.y, Bi.z);
            return this;
        },
        transformDirection: function (t) {
            for (let e = 0, n = this.count; e < n; e++)
                (Bi.x = this.getX(e)), (Bi.y = this.getY(e)), (Bi.z = this.getZ(e)), Bi.transformDirection(t), this.setXYZ(e, Bi.x, Bi.y, Bi.z);
            return this;
        },
        set: function (t, e = 0) {
    ...
    (Gi.prototype = Object.create(Ui.prototype)),
    (Gi.prototype.constructor = Gi),
    (ki.prototype = Object.create(Ui.prototype)),
    (ki.prototype.constructor = ki),
    (Vi.prototype = Object.create(Ui.prototype)),
    (Vi.prototype.constructor = Vi),
    (Wi.prototype = Object.create(Ui.prototype)),
    (Wi.prototype.constructor = Wi),
    (ji.prototype = Object.create(Ui.prototype)),
    (ji.prototype.constructor = ji),
    (qi.prototype = Object.create(Ui.prototype)),
    (qi.prototype.constructor = qi),
    (Xi.prototype = Object.create(Ui.prototype)),
    (Xi.prototype.constructor = Xi),
    (Yi.prototype = Object.create(Ui.prototype)),
    (Yi.prototype.constructor = Yi),
    (Yi.prototype.isFloat16BufferAttribute = !0),
    (Zi.prototype = Object.create(Ui.prototype)),
...
sr.prototype = Object.assign(Object.create(Ke.prototype), {
    constructor: sr,
    isBufferGeometry: !0,
    getIndex: function () {
        return this.index;
    ...
    setIndex: function (t) {
        return Array.isArray(t) ? (this.index = new (Qi(t) > 65535 ? Xi : ji)(t, 1)) : (this.index = t), this;
    },
    ...
    lookAt: function (t) {
        return tr.lookAt(t), tr.updateMatrix(), this.applyMatrix4(tr.matrix), this;
    },
    center: function () {
    ...
    computeBoundingBox: function () {
        ...
        if (t && t.isGLBufferAttribute)
            return (
                ...
                void this.boundingBox.set(new pn(-1 / 0, -1 / 0, -1 / 0), new pn(1 / 0, 1 / 0, 1 / 0))
            );
        if (void 0 !== t) {
                ...
                for (let t = 0, n = e.length; t < n; t++) {
                    ...
                    nr.setFromBufferAttribute(n),
                        this.morphTargetsRelative
                            ? (rr.addVectors(this.boundingBox.min, nr.min),
                              this.boundingBox.expandByPoint(rr),
                              rr.addVectors(this.boundingBox.max, nr.max),
                              this.boundingBox.expandByPoint(rr))
                            : (this.boundingBox.expandByPoint(nr.min), this.boundingBox.expandByPoint(nr.max));
                }
    ...
    computeBoundingSphere: function () {
        ...
        if (t && t.isGLBufferAttribute)
            return (
                ...
                void this.boundingSphere.set(new pn(), 1 / 0)
            );
        if (t) {
            const n = this.boundingSphere.center;
            if ((nr.setFromBufferAttribute(t), e))
                for (let t = 0, n = e.length; t < n; t++) {
                    const n = e[t];
                    ir.setFromBufferAttribute(n),
                        this.morphTargetsRelative
                            ? (rr.addVectors(nr.min, ir.min), nr.expandByPoint(rr), rr.addVectors(nr.max, ir.max), nr.expandByPoint(rr))
                            : (nr.expandByPoint(ir.min), nr.expandByPoint(ir.max));
                }
            nr.getCenter(n);
            let i = 0;
            for (let e = 0, r = t.count; e < r; e++) rr.fromBufferAttribute(t, e), (i = Math.max(i, n.distanceToSquared(rr)));
            if (e)
                for (let r = 0, s = e.length; r < s; r++) {
                    const s = e[r],
                        a = this.morphTargetsRelative;
                    for (let e = 0, r = s.count; e < r; e++)
                        rr.fromBufferAttribute(s, e), a && (er.fromBufferAttribute(t, e), rr.add(er)), (i = Math.max(i, n.distanceToSquared(rr)));
                }
    ...
    computeTangents: function () {
        ...
        const n = t.array,
            ...
            s = e.uv.array,
            a = i.length / 3;
        void 0 === e.tangent && this.setAttribute("tangent", new Ui(new Float32Array(4 * a), 4));
        const o = e.tangent.array,
            l = [],
            c = [];
        for (let t = 0; t < a; t++) (l[t] = new pn()), (c[t] = new pn());
        const h = new pn(),
            u = new pn(),
            d = new pn(),
            p = new nn(),
    ...
    computeVertexNormals: function () {
        ...
        if (void 0 !== e) {
            ...
            if (void 0 === n) (n = new Ui(new Float32Array(3 * e.count), 3)), this.setAttribute("normal", n);
    ...
    normalizeNormals: function () {
        ...
        for (let e = 0, n = t.count; e < n; e++) rr.fromBufferAttribute(t, e), rr.normalize(), t.setXYZ(e, rr.x, rr.y, rr.z);
    },
...
const ar = new Gn(),
    ...
    br = new pn(),
    wr = new pn();
function Mr(t = new sr(), e = new Hi()) {
    di.call(this), (this.type = "Mesh"), (this.geometry = t), (this.material = e), this.updateMorphTargets();
}
function Sr(t, e, n, i, r, s, a, o, l, c, h, u) {
    cr.fromBufferAttribute(r, c), hr.fromBufferAttribute(r, h), ur.fromBufferAttribute(r, u);
    const d = t.morphTargetInfluences;
    if (e.morphTargets && s && d) {
        mr.set(0, 0, 0), gr.set(0, 0, 0), vr.set(0, 0, 0);
        for (let t = 0, e = s.length; t < e; t++) {
            const e = d[t],
                n = s[t];
            0 !== e &&
                (dr.fromBufferAttribute(n, c),
                pr.fromBufferAttribute(n, h),
                fr.fromBufferAttribute(n, u),
                a
                    ? (mr.addScaledVector(dr, e), gr.addScaledVector(pr, e), vr.addScaledVector(fr, e))
                    : (mr.addScaledVector(dr.sub(cr), e), gr.addScaledVector(pr.sub(hr), e), vr.addScaledVector(fr.sub(ur), e)));
        }
        cr.add(mr), hr.add(gr), ur.add(vr);
    }
    t.isSkinnedMesh && e.skinning && (t.boneTransform(c, cr), t.boneTransform(h, hr), t.boneTransform(u, ur));
    const p = (function (t, e, n, i, r, s, a, o) {
        let l;
        if (((l = e.side === g ? i.intersectTriangle(a, s, r, !0, o) : i.intersectTriangle(r, s, a, e.side !== v, o)), null === l)) return null;
        wr.copy(o), wr.applyMatrix4(t.matrixWorld);
        const c = n.ray.origin.distanceTo(wr);
        return c < n.near || c > n.far ? null : {distance: c, point: wr.clone(), object: t};
    })(t, e, n, i, cr, hr, ur, br);
    if (p) {
        o &&
            (yr.fromBufferAttribute(o, c),
            xr.fromBufferAttribute(o, h),
            _r.fromBufferAttribute(o, u),
            (p.uv = Li.getUV(br, cr, hr, ur, yr, xr, _r, new nn()))),
            l &&
                (yr.fromBufferAttribute(l, c),
                xr.fromBufferAttribute(l, h),
                _r.fromBufferAttribute(l, u),
                (p.uv2 = Li.getUV(br, cr, hr, ur, yr, xr, _r, new nn())));
        const t = {a: c, b: h, c: u, normal: new pn(), materialIndex: 0};
        Li.getNormal(cr, hr, ur, t.normal), (p.face = t);
    }
    return p;
}
Mr.prototype = Object.assign(Object.create(di.prototype), {
    ...
    raycast: function (t, e) {
        ...
        if (void 0 === i) return;
        if (
            (null === n.boundingSphere && n.computeBoundingSphere(), lr.copy(n.boundingSphere), lr.applyMatrix4(r), !1 === t.ray.intersectsSphere(lr))
        )
            return;
        if ((ar.copy(r).invert(), or.copy(t.ray).applyMatrix4(ar), null !== n.boundingBox && !1 === or.intersectsBox(n.boundingBox))) return;
        let s;
                ...
                if (Array.isArray(i))
                    for (let n = 0, p = u.length; n < p; n++) {
                        ...
                        for (let n = Math.max(p.start, d.start), i = Math.min(p.start + p.count, d.start + d.count); n < i; n += 3) {
                            const i = r.getX(n),
                                u = r.getX(n + 1),
                                d = r.getX(n + 2);
                            (s = Sr(this, f, t, or, a, o, l, c, h, i, u, d)),
                    ...
                    for (let n = Math.max(0, d.start), u = Math.min(r.count, d.start + d.count); n < u; n += 3) {
                        const u = r.getX(n),
                            d = r.getX(n + 1),
                            p = r.getX(n + 2);
                        (s = Sr(this, i, t, or, a, o, l, c, h, u, d, p)), s && ((s.faceIndex = Math.floor(n / 3)), e.push(s));
                    }
                }
            else if (void 0 !== a)
                if (Array.isArray(i))
                    for (let n = 0, r = u.length; n < r; n++) {
                        ...
                        for (let n = Math.max(r.start, d.start), i = Math.min(r.start + r.count, d.start + d.count); n < i; n += 3) {
                            (s = Sr(this, p, t, or, a, o, l, c, h, n, n + 1, n + 2)),
                    ...
                    for (let n = Math.max(0, d.start), r = Math.min(a.count, d.start + d.count); n < r; n += 3) {
                        (s = Sr(this, i, t, or, a, o, l, c, h, n, n + 1, n + 2)), s && ((s.faceIndex = Math.floor(n / 3)), e.push(s));
                    }
                }
...
function Pr(t) {
    Ri.call(this),
        ...
        (this.defines = {}),
        (this.uniforms = {}),
        (this.vertexShader = Rr),
        (this.fragmentShader = Cr),
        (this.linewidth = 1),
        (this.wireframe = !1),
        (this.wireframeLinewidth = 1),
        (this.fog = !1),
...
function Dr() {
    di.call(this),
        (this.type = "Camera"),
        (this.matrixWorldInverse = new Gn()),
        (this.projectionMatrix = new Gn()),
        (this.projectionMatrixInverse = new Gn());
}
function Nr(t = 50, e = 1, n = 0.1, i = 2e3) {
    Dr.call(this),
...
(Pr.prototype = Object.create(Ri.prototype)),
    (Pr.prototype.constructor = Pr),
    (Pr.prototype.isShaderMaterial = !0),
    (Pr.prototype.copy = function (t) {
        return (
            Ri.prototype.copy.call(this, t),
    ...
    (Pr.prototype.toJSON = function (t) {
        const e = Ri.prototype.toJSON.call(this, t);
    ...
    (Dr.prototype = Object.assign(Object.create(di.prototype), {
        constructor: Dr,
        isCamera: !0,
        copy: function (t, e) {
            return (
                di.prototype.copy.call(this, t, e),
        ...
        getWorldDirection: function (t) {
            void 0 === t && (console.warn("THREE.Camera: .getWorldDirection() target is now required"), (t = new pn())),
                this.updateWorldMatrix(!0, !1);
            const e = this.matrixWorld.elements;
            return t.set(-e[8], -e[9], -e[10]).normalize();
        },
        updateMatrixWorld: function (t) {
            di.prototype.updateMatrixWorld.call(this, t), this.matrixWorldInverse.copy(this.matrixWorld).invert();
        },
        updateWorldMatrix: function (t, e) {
            di.prototype.updateWorldMatrix.call(this, t, e), this.matrixWorldInverse.copy(this.matrixWorld).invert();
        },
        clone: function () {
            return new this.constructor().copy(this);
        },
    })),
    (Nr.prototype = Object.assign(Object.create(Dr.prototype), {
        constructor: Nr,
        isPerspectiveCamera: !0,
        copy: function (t, e) {
            return (
                Dr.prototype.copy.call(this, t, e),
                (this.fov = t.fov),
                (this.zoom = t.zoom),
                (this.near = t.near),
                (this.far = t.far),
        ...
        setFocalLength: function (t) {
            ...
            (this.fov = 2 * en.RAD2DEG * Math.atan(e)), this.updateProjectionMatrix();
        },
        getFocalLength: function () {
            const t = Math.tan(0.5 * en.DEG2RAD * this.fov);
            return (0.5 * this.getFilmHeight()) / t;
        },
        getEffectiveFOV: function () {
            return 2 * en.RAD2DEG * Math.atan(Math.tan(0.5 * en.DEG2RAD * this.fov) / this.zoom);
        },
        ...
        updateProjectionMatrix: function () {
            const t = this.near;
            let e = (t * Math.tan(0.5 * en.DEG2RAD * this.fov)) / this.zoom,
                n = 2 * e,
                i = this.aspect * n,
                r = -0.5 * i;
            const s = this.view;
...
class Or extends di {
    constructor(t, e, n) {
        ...
        this.renderTarget = n;
        const i = new Nr(Ir, 1, t, e);
        (i.layers = this.layers), i.up.set(0, -1, 0), i.lookAt(new pn(1, 0, 0)), this.add(i);
        const r = new Nr(Ir, 1, t, e);
        (r.layers = this.layers), r.up.set(0, -1, 0), r.lookAt(new pn(-1, 0, 0)), this.add(r);
        const s = new Nr(Ir, 1, t, e);
        (s.layers = this.layers), s.up.set(0, 0, 1), s.lookAt(new pn(0, 1, 0)), this.add(s);
        const a = new Nr(Ir, 1, t, e);
        (a.layers = this.layers), a.up.set(0, 0, -1), a.lookAt(new pn(0, -1, 0)), this.add(a);
        const o = new Nr(Ir, 1, t, e);
        (o.layers = this.layers), o.up.set(0, -1, 0), o.lookAt(new pn(0, 0, 1)), this.add(o);
        const l = new Nr(Ir, 1, t, e);
        (l.layers = this.layers), l.up.set(0, -1, 0), l.lookAt(new pn(0, 0, -1)), this.add(l);
    }
    update(t, e) {
...
class zr extends ln {
    constructor(t, e, n, i, r, s, a, o, l, c) {
        super((t = void 0 !== t ? t : []), (e = void 0 !== e ? e : it), n, i, r, s, (a = void 0 !== a ? a : Pt), o, l, c),
...
class Hr extends un {
    constructor(t, e, n) {
        Number.isInteger(e) &&
            (console.warn("THREE.WebGLCubeRenderTarget: constructor signature is now WebGLCubeRenderTarget( size, options )"), (e = n)),
            super(t, t, e),
            (e = e || {}),
    ...
    fromEquirectangularTexture(t, e) {
        ...
        return new Or(1, 10, this).update(t, s), (e.minFilter = a), s.geometry.dispose(), s.material.dispose(), this;
    }
    clear(t, e, n, i) {
...
Br.prototype.isDataTexture = !0;
const Fr = new Dn(),
    Ur = new pn();
class Gr {
    constructor(t = new gi(), e = new gi(), n = new gi(), i = new gi(), r = new gi(), s = new gi()) {
    ...
    intersectsObject(t) {
        const e = t.geometry;
        return (
            null === e.boundingSphere && e.computeBoundingSphere(), Fr.copy(e.boundingSphere).applyMatrix4(t.matrixWorld), this.intersectsSphere(Fr)
        );
    }
    intersectsSprite(t) {
        return Fr.center.set(0, 0, 0), (Fr.radius = 0.7071067811865476), Fr.applyMatrix4(t.matrixWorld), this.intersectsSphere(Fr);
    }
    intersectsSphere(t) {
        const e = this.planes,
            n = t.center,
    ...
    intersectsBox(t) {
        ...
        for (let n = 0; n < 6; n++) {
            const i = e[n];
            if (
                ((Ur.x = i.normal.x > 0 ? t.max.x : t.min.x),
                (Ur.y = i.normal.y > 0 ? t.max.y : t.min.y),
                (Ur.z = i.normal.z > 0 ? t.max.z : t.min.z),
                i.distanceToPoint(Ur) < 0)
            )
                return !1;
        }
        return !0;
...
const jr = {
    ...
    qr = {
        ...
        normalmap: {normalMap: {value: null}, normalScale: {value: new nn(1, 1)}},
    ...
    Xr = {
        basic: {
            uniforms: Lr([qr.common, qr.specularmap, qr.envmap, qr.aomap, qr.lightmap, qr.fog]),
        ...
        standard: {
            uniforms: Lr([
                ...
                qr.fog,
                qr.lights,
                {emissive: {value: new zi(0)}, roughness: {value: 1}, metalness: {value: 0}, envMapIntensity: {value: 1}},
            ]),
        ...
        matcap: {
            uniforms: Lr([qr.common, qr.bumpmap, qr.normalmap, qr.displacementmap, qr.fog, {matcap: {value: null}}]),
            vertexShader: jr.meshmatcap_vert,
            fragmentShader: jr.meshmatcap_frag,
        },
        points: {uniforms: Lr([qr.points, qr.fog]), vertexShader: jr.points_vert, fragmentShader: jr.points_frag},
        dashed: {
            uniforms: Lr([qr.common, qr.fog, {scale: {value: 1}, dashSize: {value: 1}, totalSize: {value: 2}}]),
            vertexShader: jr.linedashed_vert,
            fragmentShader: jr.linedashed_frag,
        },
        depth: {uniforms: Lr([qr.common, qr.displacementmap]), vertexShader: jr.depth_vert, fragmentShader: jr.depth_frag},
        normal: {
            uniforms: Lr([qr.common, qr.bumpmap, qr.normalmap, qr.displacementmap, {opacity: {value: 1}}]),
            vertexShader: jr.normal_vert,
            fragmentShader: jr.normal_frag,
        },
        sprite: {uniforms: Lr([qr.sprite, qr.fog]), vertexShader: jr.sprite_vert, fragmentShader: jr.sprite_frag},
        background: {
            uniforms: {uvTransform: {value: new rn()}, t2D: {value: null}},
            vertexShader: jr.background_vert,
            fragmentShader: jr.background_frag,
        },
        cube: {uniforms: Lr([qr.envmap, {opacity: {value: 1}}]), vertexShader: jr.cube_vert, fragmentShader: jr.cube_frag},
        equirect: {uniforms: {tEquirect: {value: null}}, vertexShader: jr.equirect_vert, fragmentShader: jr.equirect_frag},
        distanceRGBA: {
            uniforms: Lr([
                qr.common,
                qr.displacementmap,
                {referencePosition: {value: new pn()}, nearDistance: {value: 1}, farDistance: {value: 1e3}},
            ]),
            vertexShader: jr.distanceRGBA_vert,
            fragmentShader: jr.distanceRGBA_frag,
        },
        shadow: {
            uniforms: Lr([qr.lights, qr.fog, {color: {value: new zi(0)}, opacity: {value: 1}}]),
    ...
    return {
        ...
        render: function (n, r, p, f) {
            ...
            x && "additive" === x.environmentBlendMode && (v = null),
                null === v ? d(s, l) : v && v.isColor && (d(v, 1), (f = !0)),
                (t.autoClear || f) && t.clear(t.autoClearColor, t.autoClearDepth, t.autoClearStencil),
                v && (v.isCubeTexture || v.isWebGLCubeRenderTarget || v.mapping === ot)
                    ? (void 0 === o &&
                          ((o = new Mr(
                              new Er(1, 1, 1),
                              new Pr({
                                  name: "BackgroundCubeMaterial",
                                  uniforms: Tr(Xr.cube.uniforms),
                      ...
                      (c === v && h === v.version && u === t.toneMapping) ||
                          ((o.material.needsUpdate = !0), (c = v), (h = v.version), (u = t.toneMapping)),
                    ...
                    : v &&
                      ...
                      (void 0 === a &&
                          ((a = new Mr(
                              ...
                              new Pr({
                                  ...
                                  uniforms: Tr(Xr.background.uniforms),
                      ...
                      (c === v && h === v.version && u === t.toneMapping) ||
                          ((a.material.needsUpdate = !0), (c = v), (h = v.version), (u = t.toneMapping)),
...
function $r(t) {
    let e = new WeakMap();
    function n(t, e) {
        return e === st ? (t.mapping = it) : e === at && (t.mapping = rt), t;
    }
    function i(t) {
        const n = t.target;
...
function es(t, e, n, i) {
    ...
    function o(t) {
        ...
        const o = new (Qi(n) > 65535 ? Xi : ji)(n, 1);
        o.version = a;
        const l = s.get(t);
...
Xr.physical = {
    uniforms: Lr([
        Xr.standard.uniforms,
        {
            ...
            clearcoatNormalScale: {value: new nn(1, 1)},
            clearcoatNormalMap: {value: null},
            sheen: {value: new zi(0)},
...
function xs(t, e, n) {
    ...
    const r = e * n;
    let s = fs[r];
    if ((void 0 === s && ((s = new Float32Array(r)), (fs[r] = s)), 0 !== e)) {
        i.toArray(s, 0);
...
function Ss(t, e) {
    ...
    if (void 0 !== e.x) (n[0] === e.x && n[1] === e.y) || (t.uniform2f(this.addr, e.x, e.y), (n[0] = e.x), (n[1] = e.y));
        ...
        if (_s(n, e)) return;
        t.uniform2fv(this.addr, e), bs(n, e);
    }
}
function Es(t, e) {
    const n = this.cache;
    if (void 0 !== e.x)
        ...
        if (_s(n, e)) return;
        t.uniform3fv(this.addr, e), bs(n, e);
    }
}
function Ts(t, e) {
    const n = this.cache;
    if (void 0 !== e.x)
        ...
        if (_s(n, e)) return;
        t.uniform4fv(this.addr, e), bs(n, e);
    }
}
function Ls(t, e) {
    const n = this.cache,
    ...
    if (void 0 === i) {
        if (_s(n, e)) return;
        t.uniformMatrix2fv(this.addr, !1, e), bs(n, e);
    } else {
        if (_s(n, i)) return;
        ys.set(i), t.uniformMatrix2fv(this.addr, !1, ys), bs(n, i);
    }
}
function As(t, e) {
    const n = this.cache,
    ...
    if (void 0 === i) {
        if (_s(n, e)) return;
        t.uniformMatrix3fv(this.addr, !1, e), bs(n, e);
    } else {
        if (_s(n, i)) return;
        vs.set(i), t.uniformMatrix3fv(this.addr, !1, vs), bs(n, i);
    }
}
function Rs(t, e) {
    const n = this.cache,
    ...
    if (void 0 === i) {
        if (_s(n, e)) return;
        t.uniformMatrix4fv(this.addr, !1, e), bs(n, e);
    } else {
        if (_s(n, i)) return;
        gs.set(i), t.uniformMatrix4fv(this.addr, !1, gs), bs(n, i);
    }
}
function Cs(t, e, n) {
    const i = this.cache,
...
function Os(t, e) {
    const n = this.cache;
    _s(n, e) || (t.uniform2iv(this.addr, e), bs(n, e));
}
function zs(t, e) {
    const n = this.cache;
    _s(n, e) || (t.uniform3iv(this.addr, e), bs(n, e));
}
function Hs(t, e) {
    const n = this.cache;
    _s(n, e) || (t.uniform4iv(this.addr, e), bs(n, e));
}
function Bs(t, e) {
    const n = this.cache;
...
function Js(t, e, n) {
    ...
    for (let t = 0; t !== i; ++t) n.safeSetTexture2D(e[t] || hs, r[t]);
}
function Qs(t, e, n) {
    const i = e.length,
        r = ws(n, i);
    t.uniform1iv(this.addr, r);
    for (let t = 0; t !== i; ++t) n.safeSetTextureCube(e[t] || ps, r[t]);
}
function Ks(t, e, n) {
    (this.id = t),
        (this.addr = n),
...
($s.prototype.updateCache = function (t) {
    ...
    (ta.prototype.setValue = function (t, e, n) {
        const i = this.seq;
...
function ia(t, e, n) {
    ...
    for (ea.lastIndex = 0; ; ) {
        ...
        if ((l && (o |= 0), void 0 === c || ("[" === c && a + 2 === r))) {
            na(n, void 0 === c ? new Ks(o, t, e) : new $s(o, t, e));
            break;
        }
        {
            let t = n.map[o];
            void 0 === t && ((t = new ta(o)), na(n, t)), (n = t);
        }
    }
}
function ra(t, e) {
...
(ra.prototype.setValue = function (t, e, n, i) {
    const r = this.map[e];
    void 0 !== r && r.setValue(t, n, i);
}),
    (ra.prototype.setOptional = function (t, e, n) {
        const i = e[n];
        void 0 !== i && this.setValue(t, n, i);
    }),
    (ra.upload = function (t, e, n, i) {
        for (let r = 0, s = e.length; r !== s; ++r) {
            const s = e[r],
                a = n[s.id];
...
const ya = /#pragma unroll_loop[\s]+?for \( int i \= (\d+)\; i < (\d+)\; i \+\+ \) \{([\s\S]+?)(?=\})\}/g,
    xa =
        /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function _a(t) {
    return t.replace(xa, wa).replace(ya, ba);
}
function ba(t, e, n, i) {
    return (
...
function Sa(t, e, n, i) {
    ...
    n.isRawShaderMaterial
        ...
        : ((x = [
          ...
          (_ = [
              ...
              n.toneMapping !== Q ? jr.tonemapping_pars_fragment : "",
              n.toneMapping !== Q ? ua("toneMapping", n.toneMapping) : "",
              n.dithering ? "#define DITHERING" : "",
              jr.encodings_pars_fragment,
              n.map ? ca("mapTexelToLinear", n.mapEncoding) : "",
              n.matcap ? ca("matcapTexelToLinear", n.matcapEncoding) : "",
              n.envMap ? ca("envMapTexelToLinear", n.envMapEncoding) : "",
              n.emissiveMap ? ca("emissiveMapTexelToLinear", n.emissiveMapEncoding) : "",
              n.lightMap ? ca("lightMapTexelToLinear", n.lightMapEncoding) : "",
    ...
    return (
        ...
        (this.getUniforms = function () {
            return void 0 === E && (E = new ra(r, y)), E;
        }),
...
function Ea(t, e, n, i, r, s) {
    ...
    return {
        getParameters: function (r, a, f, y, x) {
            const _ = y.fog,
                ...
                S = x.isSkinnedMesh
                    ? (function (t) {
                          ...
                          if (c) return 1024;
                          {
                              ...
                              return i < e.length
                                  ? (console.warn("THREE.WebGLRenderer: Skeleton has " + e.length + " bones. This GPU supports " + i + "."), 0)
                                  : i;
                          }
                      })(x)
                    : 0;
            ...
            } else (E = r.vertexShader), (T = r.fragmentShader);
            ...
            return {
                ...
                outputEncoding: null !== L ? m(L.texture) : t.outputEncoding,
                map: !!r.map,
                mapEncoding: m(r.map),
                matcap: !!r.matcap,
                ...
                envMapEncoding: m(w),
                envMapCubeUV: !!w && (w.mapping === ot || w.mapping === lt),
                lightMap: !!r.lightMap,
                ...
                objectSpaceNormalMap: r.normalMapType === qe,
                tangentSpaceNormalMap: r.normalMapType === je,
                ...
                toneMapping: r.toneMapped ? t.toneMapping : Q,
                physicallyCorrectLights: t.physicallyCorrectLights,
                premultipliedAlpha: r.premultipliedAlpha,
                alphaTest: r.alphaTest,
                doubleSided: r.side === v,
                flipSided: r.side === g,
        ...
        acquireProgram: function (e, n) {
            ...
            return void 0 === i && ((i = new Sa(t, n, e, r)), a.push(i)), i;
        },
...
function Ra(t) {
    ...
    return {
        ...
        sort: function (t, e) {
            i.length > 1 && i.sort(t || La), r.length > 1 && r.sort(e || Aa);
        },
    };
}
function Ca(t) {
    ...
    return {
        get: function (n, i) {
            let r;
            return (
                !1 === e.has(n) ? ((r = new Ra(t)), e.set(n, [r])) : i >= e.get(n).length ? ((r = new Ra(t)), e.get(n).push(r)) : (r = e.get(n)[i]), r
            );
        },
        dispose: function () {
            e = new WeakMap();
        ...
        get: function (e) {
            ...
            switch (e.type) {
                case "DirectionalLight":
                    n = {direction: new pn(), color: new zi()};
                    break;
                case "SpotLight":
                    n = {position: new pn(), direction: new pn(), color: new zi(), distance: 0, coneCos: 0, penumbraCos: 0, decay: 0};
                    break;
                case "PointLight":
                    n = {position: new pn(), color: new zi(), distance: 0, decay: 0};
                    break;
                case "HemisphereLight":
                    n = {direction: new pn(), skyColor: new zi(), groundColor: new zi()};
                    break;
                case "RectAreaLight":
                    n = {color: new zi(), position: new pn(), halfWidth: new pn(), halfHeight: new pn()};
            }
            return (t[e.id] = n), n;
        },
    };
...
function Ia(t, e) {
            ...
            return {
                get: function (e) {
                    ...
                    switch (e.type) {
                        case "DirectionalLight":
                        case "SpotLight":
                            n = {shadowBias: 0, shadowNormalBias: 0, shadowRadius: 1, shadowMapSize: new nn()};
                            break;
                        case "PointLight":
                            n = {
                                shadowBias: 0,
    ...
    for (let t = 0; t < 9; t++) r.probe.push(new pn());
    const s = new pn(),
        a = new Gn(),
        o = new Gn();
    return {
        setup: function (s) {
            ...
            d > 0 &&
                (e.isWebGL2 || !0 === t.has("OES_texture_float_linear")
                    ? ((r.rectAreaLTC1 = qr.LTC_FLOAT_1), (r.rectAreaLTC2 = qr.LTC_FLOAT_2))
                    : !0 === t.has("OES_texture_half_float_linear")
                      ? ((r.rectAreaLTC1 = qr.LTC_HALF_1), (r.rectAreaLTC2 = qr.LTC_HALF_2))
...
Ba.prototype.isMeshDistanceMaterial = !0;
var Fa =
...
function Ga(t, e, n) {
    ...
    const r = new nn(),
        ...
        u = new Pr({
            ...
            uniforms: {shadow_pass: {value: null}, resolution: {value: new nn()}, radius: {value: 4}},
            vertexShader: Ua,
            fragmentShader: Fa,
        }),
        p = u.clone();
    ...
    const x = new sr();
    x.setAttribute("position", new Ui(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
    const _ = new Mr(x, u),
        b = this;
    function w(n, i) {
        const r = e.update(_);
        (u.uniforms.shadow_pass.value = n.map.texture),
            ...
            t.clear(),
            t.renderBufferDirect(i, null, r, u, _, null),
    ...
    function M(t, e, n) {
        const i = t | (e << 1) | (n << 2);
        let r = o[i];
        return void 0 === r && ((r = new Ha({depthPacking: We, morphTargets: t, skinning: e})), (o[i] = r)), r;
    }
    function S(t, e, n) {
        const i = t | (e << 1) | (n << 2);
        let r = l[i];
        return void 0 === r && ((r = new Ba({morphTargets: t, skinning: e})), (l[i] = r)), r;
    }
    function E(e, n, i, r, s, a, o) {
        let l = null,
            u = M,
            d = e.customDepthMaterial;
        if ((!0 === r.isPointLight && ((u = S), (d = e.customDistanceMaterial)), void 0 === d)) {
            let t = !1;
            !0 === i.morphTargets && (t = n.morphAttributes && n.morphAttributes.position && n.morphAttributes.position.length > 0);
            let r = !1;
            !0 === e.isSkinnedMesh &&
                (!0 === i.skinning ? (r = !0) : console.warn("THREE.WebGLShadowMap: THREE.SkinnedMesh with material.skinning set to false:", e));
        ...
        return (
            ...
            (l.side = o === f ? (null !== i.shadowSide ? i.shadowSide : i.side) : null !== i.shadowSide ? i.shadowSide : h[i.side]),
    ...
    function T(n, r, s, a, o) {
        ...
        if (
            ...
            (n.castShadow || (n.receiveShadow && o === f)) &&
            ...
            if (Array.isArray(r)) {
                ...
                for (let l = 0, c = e.length; l < c; l++) {
                    const c = e[l],
                        h = r[c.materialIndex];
                    if (h && h.visible) {
                        const e = E(n, i, h, a, s.near, s.far, o);
                        t.renderBufferDirect(s, null, i, e, n, c);
                    }
                }
            } else if (r.visible) {
                const e = E(n, i, r, a, s.near, s.far, o);
        ...
        (this.render = function (e, o, l) {
            ...
            for (let c = 0, h = e.length; c < h; c++) {
                ...
                if (
                    ...
                    s.copy(u.mapSize),
                    (r.x > n || r.y > n) &&
                        (r.x > n && ((s.x = Math.floor(n / p.x)), (r.x = s.x * p.x), (u.mapSize.x = s.x)),
                        r.y > n && ((s.y = Math.floor(n / p.y)), (r.y = s.y * p.y), (u.mapSize.y = s.y))),
                    null === u.map && !u.isPointLightShadow && this.type === f)
                ) {
                    const t = {minFilter: mt, magFilter: mt, format: Dt};
                    (u.map = new un(r.x, r.y, t)),
                        (u.map.texture.name = h.name + ".shadowMap"),
                        (u.mapPass = new un(r.x, r.y, t)),
                        u.camera.updateProjectionMatrix();
                }
                if (null === u.map) {
                    const t = {minFilter: dt, magFilter: dt, format: Dt};
                    (u.map = new un(r.x, r.y, t)), (u.map.texture.name = h.name + ".shadowMap"), u.camera.updateProjectionMatrix();
                }
                ...
                for (let t = 0; t < m; t++) {
                    ...
                    a.set(s.x * e.x, s.y * e.y, s.x * e.z, s.y * e.w),
                        ...
                        (i = u.getFrustum()),
                        T(o, l, u.camera, h, this.type);
                }
                u.isPointLightShadow || this.type !== f || w(u, l), (u.needsUpdate = !1);
            }
...
function ka(t, e, n) {
    ...
    let o = {},
        ...
        nt = null,
        it = null;
    const rt = t.getParameter(35661);
    let st = !1,
        at = 0;
    const ot = t.getParameter(7938);
    -1 !== ot.indexOf("WebGL")
        ? ((at = parseFloat(/^WebGL (\d)/.exec(ot)[1])), (st = at >= 1))
        : -1 !== ot.indexOf("OpenGL ES") && ((at = parseFloat(/^OpenGL ES (\d)/.exec(ot)[1])), (st = at >= 2));
    let lt = null,
        ct = {};
    const ht = new hn(),
        ut = new hn();
    ...
    (pt[3553] = dt(3553, 3553, 1)),
        (pt[34067] = dt(34067, 34069, 6)),
        r.setClear(0, 0, 0, 1),
        s.setClear(1),
        a.setClear(0),
        ft(2929),
        ...
        ft(2884),
        yt(y);
    const gt = {[S]: 32774, [E]: 32778, [T]: 32779};
    if (i) (gt[L] = 32775), (gt[A] = 32776);
    else {
        const t = e.get("EXT_blend_minmax");
        null !== t && ((gt[L] = t.MIN_EXT), (gt[A] = t.MAX_EXT));
    }
    const vt = {[R]: 0, [C]: 1, [P]: 768, [N]: 770, [F]: 776, [H]: 774, [O]: 772, [D]: 769, [I]: 771, [B]: 775, [z]: 773};
    function yt(e, n, i, r, s, a, o, l) {
        if (e !== y) {
            if ((!1 === d && (ft(3042), (d = !0)), e === M))
                (s = s || n),
                    (a = a || i),
                    (o = o || r),
                    (n === f && s === Z) || (t.blendEquationSeparate(gt[n], gt[s]), (f = n), (Z = s)),
                    (i === m && r === Y && a === J && o === Q) ||
                        (t.blendFuncSeparate(vt[i], vt[r], vt[a], vt[o]), (m = i), (Y = r), (J = a), (Q = o)),
                    (p = e),
                    (K = null);
            else if (e !== p || l !== K) {
                if (((f === S && Z === S) || (t.blendEquation(32774), (f = S), (Z = S)), l))
                    switch (e) {
                        case x:
                ...
                (m = null), (Y = null), (J = null), (Q = null), (p = e), (K = l);
            }
        } else !0 === d && (mt(3042), (d = !1));
    }
    function xt(e) {
        $ !== e && (e ? t.frontFace(2304) : t.frontFace(2305), ($ = e));
    }
    function _t(e) {
        e !== c ? (ft(2884), e !== tt && (e === h ? t.cullFace(1029) : e === u ? t.cullFace(1028) : t.cullFace(1032))) : mt(2884), (tt = e);
    }
    function bt(e, n, i) {
        e ? (ft(32823), (nt === n && it === i) || (t.polygonOffset(n, i), (nt = n), (it = i))) : mt(32823);
    }
    function wt(e) {
        void 0 === e && (e = 33984 + rt - 1), lt !== e && (t.activeTexture(e), (lt = e));
    }
    return {
        ...
        bindTexture: function (e, n) {
            null === lt && wt();
            let i = ct[lt];
            void 0 === i && ((i = {type: void 0, texture: void 0}), (ct[lt] = i)),
                (i.type === e && i.texture === n) || (t.bindTexture(e, n || pt[e]), (i.type = e), (i.texture = n));
        },
        ...
        scissor: function (e) {
            !1 === ht.equals(e) && (t.scissor(e.x, e.y, e.z, e.w), ht.copy(e));
        },
        viewport: function (e) {
            !1 === ut.equals(e) && (t.viewport(e.x, e.y, e.z, e.w), ut.copy(e));
        },
        reset: function () {
            t.disable(3042),
                t.disable(2884),
...
function Va(t, e, n, i, r, s, a) {
    ...
    function g(t, e, n, i) {
        ...
        if (((t.width > i || t.height > i) && (r = i / Math.max(t.width, t.height)), r < 1 || !0 === e)) {
            if (
                ...
                const i = e ? en.floorPowerOfTwo : Math.floor,
                    s = i(r * t.width),
                    a = i(r * t.height);
                void 0 === p && (p = m(s, a));
                const o = n ? m(s, a) : p;
    ...
    function v(t) {
        return en.isPowerOfTwo(t.width) && en.isPowerOfTwo(t.height);
    }
    function y(t, e) {
    ...
    const L = {[ct]: 10497, [ht]: 33071, [ut]: 33648},
        A = {[dt]: 9728, [pt]: 9984, [ft]: 9986, [mt]: 9729, [gt]: 9985, [vt]: 9987};
    function R(n, s, a) {
        if (
            (a
            ...
            if (s.type === St && !1 === e.has("OES_texture_float_linear")) return;
            if (!1 === o && s.type === Et && !1 === e.has("OES_texture_half_float_linear")) return;
    ...
    function C(e, n) {
        void 0 === e.__webglInit &&
            ((e.__webglInit = !0), n.addEventListener("dispose", w), (e.__webglTexture = t.createTexture()), a.memory.textures++);
    }
    function P(e, i, r) {
        let a = 3553;
        ...
        const l =
                (function (t) {
                    return !o && (t.wrapS !== ht || t.wrapT !== ht || (t.minFilter !== dt && t.minFilter !== mt));
                })(i) && !1 === v(i.image),
            c = g(i.image, l, !1, h),
            u = v(c) || o,
        ...
        if (i.isDepthTexture)
            (m = 6402),
                o
                    ? (m = i.type === St ? 36012 : i.type === Mt ? 33190 : i.type === Rt ? 35056 : 33189)
                    : i.type === St && console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),
                i.format === Ot &&
                    6402 === m &&
                    i.type !== bt &&
                    i.type !== Mt &&
    ...
    function N(e, n, i) {
        if ((t.bindRenderbuffer(36161, e), n.depthBuffer && !n.stencilBuffer)) {
            ...
            if (i) {
                ...
                e && e.isDepthTexture && (e.type === St ? (r = 36012) : e.type === Mt && (r = 33190));
                const i = O(n);
        ...
        if (e.depthTexture) {
            ...
            !(function (e, n) {
                ...
                if (n.depthTexture.format === Ot) t.framebufferTexture2D(36160, 36096, 3553, r, 0);
                    ...
                    if (n.depthTexture.format !== zt) throw new Error("Unknown depthTexture format");
    ...
    (this.allocateTextureUnit = function () {
        ...
        (this.setupRenderTarget = function (e) {
            const r = e.texture,
                l = i.get(e),
                c = i.get(r);
            e.addEventListener("dispose", M), (c.__webglTexture = t.createTexture()), a.memory.textures++;
            ...
            if (
                ...
                if (o) {
                    ...
                    t.renderbufferStorageMultisample(36161, o, a, e.width, e.height),
                        ...
                        t.bindRenderbuffer(36161, null),
                        e.depthBuffer && ((l.__webglDepthRenderbuffer = t.createRenderbuffer()), N(l.__webglDepthRenderbuffer, e, !0)),
                        t.bindFramebuffer(36160, null);
...
function Wa(t, e, n) {
    ...
    return {
        convert: function (t) {
            ...
            if (t === Mt) return 5125;
            if (t === St) return 5126;
            if (t === Et) return i ? 5131 : ((n = e.get("OES_texture_half_float")), null !== n ? n.HALF_FLOAT_OES : null);
            if (t === Ct) return 6406;
            if (t === Pt) return 6407;
            if (t === Dt) return 6408;
            if (t === Nt) return 6409;
            ...
            if (t === Ht) return 6403;
            if (t === Bt) return 36244;
            if (t === Ft) return 33319;
            if (t === Ut) return 33320;
            if (t === Gt) return 36248;
            if (t === kt) return 36249;
            if (t === Vt || t === Wt || t === jt || t === qt) {
                if (((n = e.get("WEBGL_compressed_texture_s3tc")), null === n)) return null;
                if (t === Vt) return n.COMPRESSED_RGB_S3TC_DXT1_EXT;
            ...
            if (t === Xt || t === Yt || t === Zt || t === Jt) {
                ...
                if (t === Zt) return n.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
                if (t === Jt) return n.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
            }
            if (t === Qt) return (n = e.get("WEBGL_compressed_texture_etc1")), null !== n ? n.COMPRESSED_RGB_ETC1_WEBGL : null;
            if ((t === Kt || t === $t) && ((n = e.get("WEBGL_compressed_texture_etc")), null !== n)) {
                if (t === Kt) return n.COMPRESSED_RGB8_ETC2;
                if (t === $t) return n.COMPRESSED_RGBA8_ETC2_EAC;
            }
            return t === te ||
                t === ee ||
                t === ne ||
...
ja.prototype = Object.assign(Object.create(Nr.prototype), {constructor: ja, isArrayCamera: !0});
class qa extends di {
    constructor() {
...
function Ya(t, e) {
    ...
    const l = [],
        c = new Map(),
        h = new Nr();
    h.layers.enable(1), (h.viewport = new hn());
    const u = new Nr();
    u.layers.enable(2), (u.viewport = new hn());
    const d = [h, u],
        p = new ja();
    ...
    (this.enabled = !1),
        ...
        (this.getController = function (t) {
            let e = l[t];
            return void 0 === e && ((e = new Xa()), (l[t] = e)), e.getTargetRaySpace();
        }),
        (this.getControllerGrip = function (t) {
            let e = l[t];
            return void 0 === e && ((e = new Xa()), (l[t] = e)), e.getGripSpace();
        }),
        (this.getHand = function (t) {
            let e = l[t];
            return void 0 === e && ((e = new Xa()), (l[t] = e)), e.getHandSpace();
        }),
        ...
        (this.setSession = async function (t) {
            if (((i = t), null !== i)) {
                ...
                const o = {antialias: t.antialias, alpha: t.alpha, depth: t.depth, stencil: t.stencil, framebufferScaleFactor: r},
    ...
    this.getCamera = function (t) {
        (p.near = u.near = h.near = t.near),
            ...
            (f === p.near && m === p.far) || (i.updateRenderState({depthNear: p.near, depthFar: p.far}), (f = p.near), (m = p.far));
        const e = t.parent,
            n = p.cameras;
        b(p, e);
...
function Za(t) {
    function e(e, n) {
        ...
        n.lightMap && ((e.lightMap.value = n.lightMap), (e.lightMapIntensity.value = n.lightMapIntensity)),
            ...
            void 0 !== r &&
                (r.isWebGLRenderTarget && (r = r.texture), !0 === r.matrixAutoUpdate && r.updateMatrix(), e.uvTransform.value.copy(r.matrix)),
            n.aoMap ? (s = n.aoMap) : n.lightMap && (s = n.lightMap),
            void 0 !== s &&
                (s.isWebGLRenderTarget && (s = s.texture), !0 === s.matrixAutoUpdate && s.updateMatrix(), e.uv2Transform.value.copy(s.matrix));
    }
    function n(e, n) {
        (e.roughness.value = n.roughness),
            ...
            n.bumpMap && ((e.bumpMap.value = n.bumpMap), (e.bumpScale.value = n.bumpScale), n.side === g && (e.bumpScale.value *= -1)),
            n.normalMap && ((e.normalMap.value = n.normalMap), e.normalScale.value.copy(n.normalScale), n.side === g && e.normalScale.value.negate()),
            n.displacementMap &&
                  ...
                  : i.isMeshToonMaterial
                    ? (e(t, i),
                      (function (t, e) {
                          ...
                          e.emissiveMap && (t.emissiveMap.value = e.emissiveMap);
                          e.bumpMap && ((t.bumpMap.value = e.bumpMap), (t.bumpScale.value = e.bumpScale), e.side === g && (t.bumpScale.value *= -1));
                          e.normalMap &&
                      ...
                      ? (e(t, i),
                        (function (t, e) {
                            t.specular.value.copy(e.specular),
                                ...
                                e.emissiveMap && (t.emissiveMap.value = e.emissiveMap);
                            e.bumpMap &&
                                ((t.bumpMap.value = e.bumpMap), (t.bumpScale.value = e.bumpScale), e.side === g && (t.bumpScale.value *= -1));
                            e.normalMap &&
                                ((t.normalMap.value = e.normalMap),
                                t.normalScale.value.copy(e.normalScale),
                                e.side === g && t.normalScale.value.negate());
...
function Ja(t) {
    ...
    try {
        ...
        if ((e.addEventListener("webglcontextlost", mt, !1), e.addEventListener("webglcontextrestored", gt, !1), null === ht)) {
            ...
            if ((!0 === m.isWebGL1Renderer && e.shift(), (ht = ut(e, t)), null === ht))
    ...
    function dt() {
        (k = new ts(ht)),
            ...
            (lt = new Wa(ht, k, V)),
            (W = new ka(ht, k, V)),
            W.scissor(E.copy(N).multiplyScalar(R).floor()),
            W.viewport(S.copy(D).multiplyScalar(R).floor()),
            (j = new is()),
            (q = new Ta()),
            (X = new Va(ht, k, W, q, V, lt, j)),
            (Y = new $r(m)),
            (Z = new Vr(ht, V)),
            (ct = new Zr(ht, k, Z, V)),
            (J = new es(ht, Z, j, ct)),
    ...
    dt();
    const pt = new Ya(m, ht);
    this.xr = pt;
    const ft = new Ga(m, K, V.maxTextureSize);
    function mt(t) {
        t.preventDefault(), console.log("THREE.WebGLRenderer: Context Lost."), (g = !0);
    }
    function gt() {
        console.log("THREE.WebGLRenderer: Context Restored."), (g = !1), dt();
    }
    function vt(t) {
        const e = t.target;
    ...
    (this.shadowMap = ft),
        ...
        (this.setPixelRatio = function (t) {
            void 0 !== t && ((R = t), this.setSize(L, A, !1));
        }),
        (this.getSize = function (t) {
            return void 0 === t && (console.warn("WebGLRenderer: .getsize() now requires a Vector2 as an argument"), (t = new nn())), t.set(L, A);
        }),
        ...
        (this.getDrawingBufferSize = function (t) {
            return (
                void 0 === t && (console.warn("WebGLRenderer: .getdrawingBufferSize() now requires a Vector2 as an argument"), (t = new nn())),
                t.set(L * R, A * R).floor()
            );
        }),
        (this.setDrawingBufferSize = function (t, n, i) {
            (L = t), (A = n), (R = i), (e.width = Math.floor(t * i)), (e.height = Math.floor(n * i)), this.setViewport(0, 0, t, n);
        }),
        (this.getCurrentViewport = function (t) {
            return (
                void 0 === t && (console.warn("WebGLRenderer: .getCurrentViewport() now requires a Vector4 as an argument"), (t = new hn())),
                t.copy(S)
            );
        }),
        ...
        (this.setViewport = function (t, e, n, i) {
            t.isVector4 ? D.set(t.x, t.y, t.z, t.w) : D.set(t, e, n, i), W.viewport(S.copy(D).multiplyScalar(R).floor());
        }),
        (this.getScissor = function (t) {
            return t.copy(N);
        }),
        (this.setScissor = function (t, e, n, i) {
            t.isVector4 ? N.set(t.x, t.y, t.z, t.w) : N.set(t, e, n, i), W.scissor(E.copy(N).multiplyScalar(R).floor());
        }),
        ...
        (this.getClearColor = function (t) {
            return (
                void 0 === t && (console.warn("WebGLRenderer: .getClearColor() now requires a Color as an argument"), (t = new zi())),
                t.copy(rt.getClearColor())
            );
        }),
        ...
        (this.renderBufferDirect = function (t, e, n, i, r, s) {
            ...
            let h,
                u = 1;
            !0 === i.wireframe && ((l = J.getWireframeAttribute(n)), (u = 2)),
                (i.morphTargets || i.morphNormals) && st.update(r, n, i, o),
                ct.setup(r, i, o, n, l);
            let d = at;
            null !== l && ((h = Z.get(l)), (d = ot), d.setIndex(h));
                ...
                if (i)
                    if (Array.isArray(i))
                        for (let r = 0; r < i.length; r++) {
                            const s = i[r];
                            !1 === n.has(s) && (Lt(s, t, e), n.set(s));
                        }
                    else !1 === n.has(i) && (Lt(i, t, e), n.set(i));
            });
        });
    let _t = null;
    const bt = new kr();
    function wt(t, e, n, i) {
        ...
        if (t.layers.test(e.layers))
            if (t.isGroup) n = t.renderOrder;
                ...
                (t.isSkinnedMesh && t.skeleton.frame !== j.render.frame && (t.skeleton.update(), (t.skeleton.frame = j.render.frame)),
                ...
                if (Array.isArray(r)) {
                    ...
                    for (let s = 0, a = i.length; s < a; s++) {
                        const a = i[s],
                            o = r[a.materialIndex];
                        o && o.visible && u.push(t, e, o, n, F.z, a);
                    }
    ...
    function Mt(t, e, n) {
        ...
        for (let r = 0, s = t.length; r < s; r++) {
            ...
            if (n.isArrayCamera) {
                ...
                for (let n = 0, i = t.length; n < i; n++) {
                    const i = t[n];
                    a.layers.test(i.layers) && (W.viewport(S.copy(i.viewport)), d.setupLightsView(i), Tt(a, e, i, o, l, c));
                }
            } else Tt(a, e, n, o, l, c);
        }
    }
    ...
    function Lt(t, e, n) {
        ...
        if (
            ...
            (i.fog = e.fog),
            (i.envMap = Y.get(t.envMap || i.environment)),
            void 0 === c)
        )
            t.addEventListener("dispose", vt);
        else if (c.cacheKey !== l) xt(t);
        ...
        ((t.isShaderMaterial || t.isRawShaderMaterial) && !0 !== t.clipping) ||
            ((i.numClippingPlanes = it.numPlanes), (i.numIntersection = it.numIntersection), (u.clippingPlanes = it.uniform)),
    ...
    function At(t, e, n, i) {
        ...
        n.version === l.__version
            ? (n.fog && l.fog !== r) || l.environment !== s || (l.needsLights && l.lightsStateVersion !== c.state.version)
                ? Lt(n, e, i)
                : void 0 === l.numClippingPlanes || (l.numClippingPlanes === it.numPlanes && l.numIntersection === it.numIntersection)
                  ? (l.outputEncoding !== a || l.envMap !== o) && Lt(n, e, i)
                  : Lt(n, e, i)
            : (Lt(n, e, i), (l.__version = n.version));
        let h = !1,
            u = !1,
            p = !1;
        const f = l.program,
            g = f.getUniforms(),
            v = l.uniforms;
        if ((W.useProgram(f.program) && ((h = !0), (u = !0), (p = !0)), n.id !== w && ((w = n.id), (u = !0)), h || M !== t)) {
            if (
                (g.setValue(ht, "projectionMatrix", t.projectionMatrix),
                V.logarithmicDepthBuffer && g.setValue(ht, "logDepthBufFC", 2 / (Math.log(t.far + 1) / Math.LN2)),
                M !== t && ((M = t), (u = !0), (p = !0)),
            ...
            (n.isMeshPhongMaterial ||
                ...
                n.isShaderMaterial) &&
                g.setValue(ht, "isOrthographic", !0 === t.isOrthographicCamera),
                (n.isMeshPhongMaterial ||
                    n.isMeshToonMaterial ||
                    n.isMeshLambertMaterial ||
                    n.isMeshBasicMaterial ||
                    ...
                    n.isShadowMaterial ||
                    n.skinning) &&
                    g.setValue(ht, "viewMatrix", t.matrixWorldInverse);
        }
        if (n.skinning) {
            g.setOptional(ht, i, "bindMatrix"), g.setOptional(ht, i, "bindMatrixInverse");
            const t = i.skeleton;
            if (t) {
                const e = t.bones;
                if (V.floatVertexTextures) {
                    if (null === t.boneTexture) {
                        ...
                        (n = en.ceilPowerOfTwo(n)), (n = Math.max(n, 4));
                        const i = new Float32Array(n * n * 4);
                        i.set(t.boneMatrices);
                        const r = new Br(i, n, n, Dt, St);
                        (t.boneMatrices = i), (t.boneTexture = r), (t.boneTextureSize = n);
                    }
                    g.setValue(ht, "boneTexture", t.boneTexture, X), g.setValue(ht, "boneTextureSize", t.boneTextureSize);
                } else g.setOptional(ht, t, "boneMatrices");
            }
        }
        var y, x;
        return (
            (u || l.receiveShadow !== i.receiveShadow) && ((l.receiveShadow = i.receiveShadow), g.setValue(ht, "receiveShadow", i.receiveShadow)),
            u &&
                (g.setValue(ht, "toneMappingExposure", m.toneMappingExposure),
                l.needsLights &&
                    ((x = p),
                ...
                r && n.fog && tt.refreshFogUniforms(v, r),
                tt.refreshMaterialUniforms(v, n, R, A),
                ra.upload(ht, l.uniformsList, v, X)),
            n.isShaderMaterial && !0 === n.uniformsNeedUpdate && (ra.upload(ht, l.uniformsList, v, X), (n.uniformsNeedUpdate = !1)),
            n.isSpriteMaterial && g.setValue(ht, "center", i.center),
            g.setValue(ht, "modelViewMatrix", i.modelViewMatrix),
            g.setValue(ht, "normalMatrix", i.normalMatrix),
            g.setValue(ht, "modelMatrix", i.matrixWorld),
            f
        );
    }
    bt.setAnimationLoop(function (t) {
        pt.isPresenting || (_t && _t(t));
    }),
        "undefined" != typeof window && bt.setContext(window),
        (this.setAnimationLoop = function (t) {
            (_t = t), pt.setAnimationLoop(t), null === t ? bt.stop() : bt.start();
        }),
        (this.render = function (t, e) {
            ...
            ct.resetDefaultState(),
                ...
                !0 === pt.enabled && !0 === pt.isPresenting && (e = pt.getCamera(e)),
                ...
                (z = it.init(this.clippingPlanes, H, e)),
                (u = et.get(t, p.length)),
                u.init(),
                p.push(u),
            ...
            s.length > 0 && Mt(s, t, e),
                ...
                null !== _ && (X.updateRenderTargetMipmap(_), X.updateMultisampleRenderTarget(_)),
        ...
        (this.setFramebuffer = function (t) {
            v !== t && null === _ && ht.bindFramebuffer(36160, t), (v = t);
        }),
        ...
        (this.setRenderTarget = function (t, e = 0, n = 0) {
            ...
            if (t) {
                ...
                t.isWebGLCubeRenderTarget
                    ...
                    E.copy(t.scissor),
                    (T = t.scissorTest);
            } else S.copy(D).multiplyScalar(R).floor(), E.copy(N).multiplyScalar(R).floor(), (T = I);
            if ((b !== i && (ht.bindFramebuffer(36160, i), (b = i)), W.viewport(S), W.scissor(E), W.setScissorTest(T), r)) {
        ...
        (this.readRenderTargetPixels = function (t, e, n, i, r, s, a) {
            ...
            if ((t.isWebGLCubeRenderTarget && void 0 !== a && (o = o[a]), o)) {
                let a = !1;
                o !== b && (ht.bindFramebuffer(36160, o), (a = !0));
                try {
                    const a = t.texture,
                        o = a.format,
                        l = a.type;
                    if (o !== Dt && lt.convert(o) !== ht.getParameter(35739))
                        return void console.error(
                            "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format."
                        );
                    const c = l === Et && (k.has("EXT_color_buffer_half_float") || (V.isWebGL2 && k.has("EXT_color_buffer_float")));
                    if (
                        !(
                            l === yt ||
                            lt.convert(l) === ht.getParameter(35738) ||
                            (l === St && (V.isWebGL2 || k.has("OES_texture_float") || k.has("WEBGL_color_buffer_float"))) ||
                            c
                        )
                    )
                        return void console.error(
                    ...
                    36053 === ht.checkFramebufferStatus(36160)
                        ? e >= 0 && e <= t.width - i && n >= 0 && n <= t.height - r && ht.readPixels(e, n, i, r, lt.convert(o), lt.convert(l), s)
                        : console.error("THREE.WebGLRenderer.readRenderTargetPixels: readPixels from renderTarget failed. Framebuffer not complete.");
                } finally {
                    a && ht.bindFramebuffer(36160, b);
                }
            }
        }),
        (this.copyFramebufferToTexture = function (t, e, n = 0) {
            ...
            X.setTexture2D(e, 0), ht.copyTexImage2D(3553, n, a, t.x, t.y, r, s, 0), W.unbindTexture();
        }),
        (this.copyTextureToTexture = function (t, e, n, i = 0) {
            ...
            X.setTexture2D(n, 0),
                ...
                e.isDataTexture
                    ? ht.texSubImage2D(3553, i, t.x, t.y, r, s, a, o, e.image.data)
                    : e.isCompressedTexture
                      ? ht.compressedTexSubImage2D(3553, i, t.x, t.y, e.mipmaps[0].width, e.mipmaps[0].height, a, e.mipmaps[0].data)
                      : ht.texSubImage2D(3553, i, t.x, t.y, a, o, e.image),
        ...
        (this.copyTextureToTexture3D = function (t, e, n, i, r = 0) {
            ...
            ht.pixelStorei(3314, s),
                ht.pixelStorei(32878, a),
                ht.pixelStorei(3316, t.min.x),
                ht.pixelStorei(3315, t.min.y),
                ht.pixelStorei(32877, t.min.z),
                ht.texSubImage3D(h, r, e.x, e.y, e.z, t.max.x - t.min.x + 1, t.max.y - t.min.y + 1, t.max.z - t.min.z + 1, l, c, o),
                ht.pixelStorei(3314, u),
                ht.pixelStorei(32878, d),
                ht.pixelStorei(3316, p),
                ht.pixelStorei(3315, f),
                ht.pixelStorei(32877, g),
                0 === r && i.generateMipmaps && ht.generateMipmap(h),
                W.unbindTexture();
        }),
...
(qa.prototype.isGroup = !0),
    Object.assign(Xa.prototype, {
        ...
        getTargetRaySpace: function () {
            return (
                null === this._targetRay && ((this._targetRay = new qa()), (this._targetRay.matrixAutoUpdate = !1), (this._targetRay.visible = !1)),
                this._targetRay
            );
        },
        getGripSpace: function () {
            return null === this._grip && ((this._grip = new qa()), (this._grip.matrixAutoUpdate = !1), (this._grip.visible = !1)), this._grip;
        },
        dispatchEvent: function (t) {
            return (
            ...
            if (t && "visible-blurred" !== e.session.visibilityState)
                if (l && t.hand) {
                    ...
                    for (const i of t.hand.values()) {
                        ...
                        null !== t &&
                            (r.matrix.fromArray(t.transform.matrix), r.matrix.decompose(r.position, r.rotation, r.scale), (r.jointRadius = t.radius)),
                            (r.visible = null !== t);
                    }
                    ...
                    null !== a &&
                        ...
                        null !== i && (a.matrix.fromArray(i.transform.matrix), a.matrix.decompose(a.position, a.rotation, a.scale))),
                        null !== o &&
                            t.gripSpace &&
                            ((r = e.getPose(t.gripSpace, n)),
                            null !== r && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale)));
            return null !== a && (a.visible = null !== i), null !== o && (o.visible = null !== r), null !== l && (l.visible = null !== s), this;
        },
    }),
    Object.assign(Ya.prototype, Ke.prototype);
    ...
    Object.assign(Ka.prototype, {
        ...
        clone: function (t) {
            void 0 === t.arrayBuffers && (t.arrayBuffers = {}),
                void 0 === this.array.buffer._uuid && (this.array.buffer._uuid = en.generateUUID()),
                void 0 === t.arrayBuffers[this.array.buffer._uuid] && (t.arrayBuffers[this.array.buffer._uuid] = this.array.slice(0).buffer);
            const e = new Ka(new this.array.constructor(t.arrayBuffers[this.array.buffer._uuid]), this.stride);
    ...
    Object.assign(to.prototype, {
        ...
        applyMatrix4: function (t) {
            for (let e = 0, n = this.data.count; e < n; e++)
                ($a.x = this.getX(e)), ($a.y = this.getY(e)), ($a.z = this.getZ(e)), $a.applyMatrix4(t), this.setXYZ(e, $a.x, $a.y, $a.z);
            return this;
        },
        setX: function (t, e) {
        ...
        clone: function (t) {
            if (void 0 === t) {
                ...
                return new Ui(new this.array.constructor(t), this.itemSize, this.normalized);
            }
            return (
                void 0 === t.interleavedBuffers && (t.interleavedBuffers = {}),
                void 0 === t.interleavedBuffers[this.data.uuid] && (t.interleavedBuffers[this.data.uuid] = this.data.clone(t)),
                new to(t.interleavedBuffers[this.data.uuid], this.itemSize, this.offset, this.normalized)
            );
        },
        toJSON: function (t) {
            if (void 0 === t) {
...
let no;
eo.prototype.isSpriteMaterial = !0;
const io = new pn(),
    ro = new pn(),
    so = new pn(),
    ao = new nn(),
...
function go(t, e, n, i, r, s) {
    ao.subVectors(t, n).addScalar(0.5).multiply(i),
        void 0 !== r ? ((oo.x = s * ao.x - r * ao.y), (oo.y = r * ao.x + s * ao.y)) : oo.copy(ao),
        t.copy(e),
        (t.x += oo.x),
        (t.y += oo.y),
        t.applyMatrix4(lo);
...
(class extends di {
    constructor(t) {
        if ((super(), (this.type = "Sprite"), void 0 === no)) {
            no = new sr();
            const t = new Ka(new Float32Array([-0.5, -0.5, 0, 0, 0, 0.5, -0.5, 0, 1, 0, 0.5, 0.5, 0, 1, 1, -0.5, 0.5, 0, 0, 1]), 5);
            no.setIndex([0, 1, 2, 0, 2, 3]), no.setAttribute("position", new to(t, 3, 0, !1)), no.setAttribute("uv", new to(t, 2, 3, !1));
        }
        (this.geometry = no), (this.material = void 0 !== t ? t : new eo()), (this.center = new nn(0.5, 0.5));
    }
    raycast(t, e) {
        null === t.camera && console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),
            ro.setFromMatrixScale(this.matrixWorld),
            lo.copy(t.camera.matrixWorld),
            ...
            t.camera.isPerspectiveCamera && !1 === this.material.sizeAttenuation && ro.multiplyScalar(-so.z);
        const n = this.material.rotation;
        let i, r;
        0 !== n && ((r = Math.cos(n)), (i = Math.sin(n)));
        const s = this.center;
        go(co.set(-0.5, -0.5, 0), so, s, ro, i, r),
            go(ho.set(0.5, -0.5, 0), so, s, ro, i, r),
            go(uo.set(0.5, 0.5, 0), so, s, ro, i, r),
            po.set(0, 0),
            fo.set(1, 0),
            mo.set(1, 1);
        let a = t.ray.intersectTriangle(co, ho, uo, !1, io);
        if (null === a && (go(ho.set(-0.5, 0.5, 0), so, s, ro, i, r), fo.set(0, 1), (a = t.ray.intersectTriangle(co, uo, ho, !1, io)), null === a))
            return;
        const o = t.ray.origin.distanceTo(io);
        o < t.near ||
            o > t.far ||
            e.push({distance: o, point: io.clone(), uv: Li.getUV(io, co, ho, uo, po, fo, mo, new nn()), face: null, object: this});
    }
    copy(t) {
...
const vo = new pn(),
    ...
    bo = new Gn();
function wo(t, e) {
    Mr.call(this, t, e), (this.type = "SkinnedMesh"), (this.bindMode = "attached"), (this.bindMatrix = new Gn()), (this.bindMatrixInverse = new Gn());
}
function Mo() {
    di.call(this), (this.type = "Bone");
}
(wo.prototype = Object.assign(Object.create(Mr.prototype), {
    constructor: wo,
    isSkinnedMesh: !0,
    copy: function (t) {
        return (
    ...
    boneTransform: function (t, e) {
        ...
        yo.fromBufferAttribute(i.attributes.skinIndex, t),
            xo.fromBufferAttribute(i.attributes.skinWeight, t),
            vo.fromBufferAttribute(i.attributes.position, t).applyMatrix4(this.bindMatrix),
            e.set(0, 0, 0);
        for (let t = 0; t < 4; t++) {
            const i = xo.getComponent(t);
            if (0 !== i) {
                const r = yo.getComponent(t);
                bo.multiplyMatrices(n.bones[r].matrixWorld, n.boneInverses[r]), e.addScaledVector(_o.copy(vo).applyMatrix4(bo), i);
            }
        }
        return e.applyMatrix4(this.bindMatrixInverse);
    },
})),
    (Mo.prototype = Object.assign(Object.create(di.prototype), {constructor: Mo, isBone: !0}));
const So = new Gn(),
    Eo = new Gn(),
    To = [],
    Lo = new Mr();
function Ao(t, e, n) {
    Mr.call(this, t, e),
        (this.instanceMatrix = new Ui(new Float32Array(16 * n), 16)),
        (this.instanceColor = null),
        (this.count = n),
        (this.frustumCulled = !1);
}
Ao.prototype = Object.assign(Object.create(Mr.prototype), {
    constructor: Ao,
    isInstancedMesh: !0,
    copy: function (t) {
        return (
    ...
    raycast: function (t, e) {
        const n = this.matrixWorld,
            i = this.count;
        if (((Lo.geometry = this.geometry), (Lo.material = this.material), void 0 !== Lo.material))
            for (let r = 0; r < i; r++) {
                this.getMatrixAt(r, So), Eo.multiplyMatrices(n, So), (Lo.matrixWorld = Eo), Lo.raycast(t, To);
                for (let t = 0, n = To.length; t < n; t++) {
                    const n = To[t];
    ...
    setColorAt: function (t, e) {
        null === this.instanceColor && (this.instanceColor = new Ui(new Float32Array(3 * this.count), 3)), e.toArray(this.instanceColor.array, 3 * t);
    },
...
const Co = new pn(),
    ...
    No = new Un(),
    Io = new Dn();
function Oo(t = new sr(), e = new Ro()) {
    di.call(this), (this.type = "Line"), (this.geometry = t), (this.material = e), this.updateMorphTargets();
}
Oo.prototype = Object.assign(Object.create(di.prototype), {
    constructor: Oo,
    isLine: !0,
    copy: function (t) {
        return di.prototype.copy.call(this, t), (this.material = t.material), (this.geometry = t.geometry), this;
    },
        ...
        if (t.isBufferGeometry)
            if (null === t.index) {
                ...
                for (let t = 1, i = e.count; t < i; t++)
                    Co.fromBufferAttribute(e, t - 1), Po.fromBufferAttribute(e, t), (n[t] = n[t - 1]), (n[t] += Co.distanceTo(Po));
    ...
    raycast: function (t, e) {
        ...
        if (
            ...
            return;
        Do.copy(i).invert(), No.copy(t.ray).applyMatrix4(Do);
        ...
        if (n.isBufferGeometry) {
            ...
            if (null !== i) {
                ...
                for (let i = 0, s = n.length - 1; i < s; i += u) {
                    const s = n[i],
                        u = n[i + 1];
                    o.fromBufferAttribute(r, s), l.fromBufferAttribute(r, u);
                    if (No.distanceSqToSegment(o, l, h, c) > a) continue;
                    h.applyMatrix4(this.matrixWorld);
                    const d = t.ray.origin.distanceTo(h);
                    d < t.near ||
                        d > t.far ||
                        e.push({distance: d, point: c.clone().applyMatrix4(this.matrixWorld), index: i, face: null, faceIndex: null, object: this});
                }
            } else
                for (let n = 0, i = r.count - 1; n < i; n += u) {
                    o.fromBufferAttribute(r, n), l.fromBufferAttribute(r, n + 1);
                    if (No.distanceSqToSegment(o, l, h, c) > a) continue;
                    h.applyMatrix4(this.matrixWorld);
                    const i = t.ray.origin.distanceTo(h);
                    i < t.near ||
                        i > t.far ||
                        e.push({distance: i, point: c.clone().applyMatrix4(this.matrixWorld), index: n, face: null, faceIndex: null, object: this});
                }
...
const zo = new pn(),
    Ho = new pn();
function Bo(t, e) {
    Oo.call(this, t, e), (this.type = "LineSegments");
}
        ...
        if (t.isBufferGeometry)
            if (null === t.index) {
                ...
                for (let t = 0, i = e.count; t < i; t += 2)
                    zo.fromBufferAttribute(e, t),
                        Ho.fromBufferAttribute(e, t + 1),
                        (n[t] = 0 === t ? 0 : n[t - 1]),
                        (n[t + 1] = n[t] + zo.distanceTo(Ho));
                t.setAttribute("lineDistance", new Zi(n, 1));
...
Fo.prototype.isPointsMaterial = !0;
const Uo = new Gn(),
    Go = new Un(),
    ko = new Dn(),
    Vo = new pn();
function Wo(t = new sr(), e = new Fo()) {
    di.call(this), (this.type = "Points"), (this.geometry = t), (this.material = e), this.updateMorphTargets();
}
function jo(t, e, n, i, r, s, a) {
    const o = Go.distanceSqToPoint(t);
    if (o < n) {
        const n = new pn();
        Go.closestPointToPoint(t, n), n.applyMatrix4(i);
        const l = r.ray.origin.distanceTo(n);
        if (l < r.near || l > r.far) return;
        s.push({distance: l, distanceToRay: Math.sqrt(o), point: n, index: e, face: null, object: a});
    }
}
Wo.prototype = Object.assign(Object.create(di.prototype), {
    constructor: Wo,
    isPoints: !0,
    copy: function (t) {
        return di.prototype.copy.call(this, t), (this.material = t.material), (this.geometry = t.geometry), this;
    ...
    raycast: function (t, e) {
        ...
        if (
            (null === n.boundingSphere && n.computeBoundingSphere(),
            ko.copy(n.boundingSphere),
            ko.applyMatrix4(i),
            (ko.radius += r),
            !1 === t.ray.intersectsSphere(ko))
        )
            return;
        Uo.copy(i).invert(), Go.copy(t.ray).applyMatrix4(Uo);
        const s = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
            a = s * s;
        if (n.isBufferGeometry) {
            const r = n.index,
            ...
            if (null !== r) {
                ...
                for (let r = 0, o = n.length; r < o; r++) {
                    const o = n[r];
                    Vo.fromBufferAttribute(s, o), jo(Vo, o, a, i, t, e, this);
                }
            } else for (let n = 0, r = s.count; n < r; n++) Vo.fromBufferAttribute(s, n), jo(Vo, n, a, i, t, e, this);
...
(class extends ln {
    constructor(t, e, n, i, r, s, a, o, l, c) {
        if ((c = void 0 !== c ? c : Ot) !== Ot && c !== zt)
            throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");
        void 0 === n && c === Ot && (n = bt),
            void 0 === n && c === zt && (n = Rt),
            super(null, i, r, s, a, o, c, n, l),
            (this.image = {width: t, height: e}),
            (this.magFilter = void 0 !== a ? a : dt),
            ...
            (s = (function (t, e, n, i) {
                ...
                for (s = 0, a = e.length; s < a; s++)
                    (o = e[s] * i),
                        ...
                        r.push(sl(c));
                for (r.sort(el), s = 0; s < r.length; s++) nl(r[s], n), (n = Zo(n, n.next));
                return n;
            })(t, e, s, n)),
        t.length > 80 * n)
    ) {
...
function Yo(t, e, n, i, r) {
    ...
    if (
        ...
        for (s = e; s < n; s += i) a = ml(s, t[s], t[s + 1], a);
    else for (s = n - i; s >= e; s -= i) a = ml(s, t[s], t[s + 1], a);
    return a && cl(a, a.next) && (gl(a), (a = a.next)), a;
}
function Zo(t, e) {
    if (!t) return t;
    e || (e = t);
    let n,
        i = t;
    do {
        if (((n = !1), i.steiner || (!cl(i, i.next) && 0 !== ll(i.prev, i, i.next)))) i = i.next;
        else {
            if ((gl(i), (i = e = i.prev), i === i.next)) break;
            n = !0;
        }
    } while (n || i !== e);
    return e;
...
function Jo(t, e, n, i, r, s, a) {
    ...
    !a &&
        ...
        (function (t, e, n, i) {
            let r = t;
            do {
                null === r.z && (r.z = rl(r.x, r.y, e, n, i)), (r.prevZ = r.prev), (r.nextZ = r.next), (r = r.next);
            } while (r !== t);
            (r.prevZ.nextZ = null),
                (r.prevZ = null),
                (function (t) {
    ...
    let o,
        ...
        c = t;
    for (; t.prev !== t.next; )
        if (((o = t.prev), (l = t.next), s ? Ko(t, i, r, s) : Qo(t)))
            e.push(o.i / n), e.push(t.i / n), e.push(l.i / n), gl(t), (t = l.next), (c = l.next);
        else if ((t = l) === c) {
            a ? (1 === a ? Jo((t = $o(Zo(t), e, n)), e, n, i, r, s, 2) : 2 === a && tl(t, e, n, i, r, s)) : Jo(Zo(t), e, n, i, r, s, 1);
            break;
        }
}
function Qo(t) {
    const e = t.prev,
        n = t,
        i = t.next;
    if (ll(e, n, i) >= 0) return !1;
    let r = t.next.next;
    for (; r !== t.prev; ) {
        if (al(e.x, e.y, n.x, n.y, i.x, i.y, r.x, r.y) && ll(r.prev, r, r.next) >= 0) return !1;
        r = r.next;
    }
    return !0;
}
function Ko(t, e, n, i) {
    ...
    let p = t.prevZ,
        f = t.nextZ;
    for (; p && p.z >= u && f && f.z <= d; ) {
        if (p !== t.prev && p !== t.next && al(r.x, r.y, s.x, s.y, a.x, a.y, p.x, p.y) && ll(p.prev, p, p.next) >= 0) return !1;
        if (((p = p.prevZ), f !== t.prev && f !== t.next && al(r.x, r.y, s.x, s.y, a.x, a.y, f.x, f.y) && ll(f.prev, f, f.next) >= 0)) return !1;
        f = f.nextZ;
    }
    for (; p && p.z >= u; ) {
        if (p !== t.prev && p !== t.next && al(r.x, r.y, s.x, s.y, a.x, a.y, p.x, p.y) && ll(p.prev, p, p.next) >= 0) return !1;
    ...
    for (; f && f.z <= d; ) {
        if (f !== t.prev && f !== t.next && al(r.x, r.y, s.x, s.y, a.x, a.y, f.x, f.y) && ll(f.prev, f, f.next) >= 0) return !1;
        f = f.nextZ;
    }
    return !0;
}
function $o(t, e, n) {
    ...
    do {
        ...
        !cl(r, s) &&
            ...
            pl(r, s) &&
            pl(s, r) &&
            (e.push(r.i / n), e.push(i.i / n), e.push(s.i / n), gl(i), gl(i.next), (i = t = s)),
            (i = i.next);
    } while (i !== t);
    return Zo(i);
}
function tl(t, e, n, i, r, s) {
    ...
    do {
        ...
        for (; t !== a.prev; ) {
            if (a.i !== t.i && ol(a, t)) {
                let o = fl(a, t);
                return (a = Zo(a, a.next)), (o = Zo(o, o.next)), Jo(a, e, n, i, r, s), void Jo(o, e, n, i, r, s);
            }
            t = t.next;
        }
        a = a.next;
        ...
        ((e = (function (t, e) {
            ...
            do {
                i >= n.x &&
                    n.x >= l &&
                    i !== n.x &&
                    al(r < c ? i : a, r, l, c, r < c ? a : i, r, n.x, n.y) &&
                    ((h = Math.abs(r - n.y) / (i - n.x)),
                    pl(n, t) && (h < u || (h === u && (n.x > s.x || (n.x === s.x && il(s, n))))) && ((s = n), (u = h))),
                    (n = n.next);
            } while (n !== o);
            return s;
        })(t, e)),
...
function rl(t, e, n, i, r) {
    return (
        (t =
            1431655765 &
            ((t = 858993459 & ((t = 252645135 & ((t = 16711935 & ((t = 32767 * (t - n) * r) | (t << 8))) | (t << 4))) | (t << 2))) | (t << 1))) |
        ((e =
            1431655765 &
            ((e = 858993459 & ((e = 252645135 & ((e = 16711935 & ((e = 32767 * (e - i) * r) | (e << 8))) | (e << 4))) | (e << 2))) | (e << 1))) <<
            1)
    );
}
function sl(t) {
...
function ol(t, e) {
    return (
        ...
        !(function (t, e) {
            let n = t;
            do {
                if (n.i !== t.i && n.next.i !== t.i && n.i !== e.i && n.next.i !== e.i && hl(n, n.next, t, e)) return !0;
                n = n.next;
            } while (n !== t);
            return !1;
        })(t, e) &&
        ((pl(t, e) &&
            ...
            (cl(t, e) && ll(t.prev, t, t.next) > 0 && ll(e.prev, e, e.next) > 0))
    );
}
function ll(t, e, n) {
...
function hl(t, e, n, i) {
    const r = dl(ll(t, e, n)),
        ...
        o = dl(ll(n, i, e));
    return (
        (r !== s && a !== o) || !(0 !== r || !ul(t, n, e)) || !(0 !== s || !ul(t, i, e)) || !(0 !== a || !ul(n, t, i)) || !(0 !== o || !ul(n, e, i))
    );
}
function ul(t, e, n) {
...
function pl(t, e) {
    return ll(t.prev, t, t.next) < 0 ? ll(t, e, t.next) >= 0 && ll(t, t.prev, e) >= 0 : ll(t, e, t.prev) < 0 || ll(t, t.next, e) < 0;
}
function fl(t, e) {
    const n = new vl(t.i, t.x, t.y),
        i = new vl(e.i, e.x, e.y),
        r = t.next,
        s = e.prev;
    return (t.next = e), (e.prev = t), (n.next = r), (r.prev = n), (i.next = n), (n.prev = i), (s.next = i), (i.prev = s), i;
}
function ml(t, e, n, i) {
    const r = new vl(t, e, n);
...
const yl = {
    ...
    triangulateShape: function (t, e) {
        ...
        let s = t.length;
        e.forEach(xl);
        for (let t = 0; t < e.length; t++) i.push(s), (s += e[t].length), _l(n, e[t]);
        const a = Xo(n, i);
...
class bl extends sr {
    constructor(t, e) {
        ...
        function s(t) {
            ...
            const f = e.extrudePath,
                m = void 0 !== e.UVGenerator ? e.UVGenerator : wl;
            ...
            let g,
                ...
                _,
                b = !1;
            f && ((g = f.getSpacedPoints(o)), (b = !0), (c = !1), (v = f.computeFrenetFrames(o, !1)), (y = new pn()), (x = new pn()), (_ = new pn())),
                c || ((p = 0), (h = 0), (u = 0), (d = 0));
            ...
            if (!yl.isClockWise(M)) {
                ...
                for (let t = 0, e = S.length; t < e; t++) {
                    const e = S[t];
                    yl.isClockWise(e) && (S[t] = e.reverse());
                }
            }
            const E = yl.triangulateShape(M, S),
                T = M;
            for (let t = 0, e = S.length; t < e; t++) {
                const e = S[t];
                M = M.concat(e);
            ...
            function C(t, e, n) {
                ...
                return new nn(i / s, r / s);
            }
            const P = [];
            for (let t = 0, e = T.length, n = e - 1, i = t + 1; t < e; t++, n++, i++)
                n === e && (n = 0), i === e && (i = 0), (P[t] = C(T[t], T[n], T[i]));
            const D = [];
            let N,
                I = P.concat();
            for (let t = 0, e = S.length; t < e; t++) {
                ...
                for (let t = 0, n = e.length, i = n - 1, r = t + 1; t < n; t++, i++, r++)
                    i === n && (i = 0), r === n && (r = 0), (N[t] = C(e[t], e[i], e[r]));
            ...
            for (let t = p - 1; t >= 0; t--) {
                ...
                for (let t = 0, e = S.length; t < e; t++) {
                    ...
                    for (let t = 0, r = e.length; t < r; t++) {
                        const r = L(e[t], N[t], i);
                        b ? H(r.x, r.y + g[o - 1].y, g[o - 1].x + n) : H(r.x, r.y, l + n);
                    }
                }
            }
            function z(t, e) {
    ...
    toJSON() {
        const t = sr.prototype.toJSON.call(this);
...
const wl = {
    generateTopUV: function (t, e, n, i, r) {
        const s = e[3 * n],
            ...
            c = e[3 * r],
            h = e[3 * r + 1];
        return [new nn(s, a), new nn(o, l), new nn(c, h)];
    },
    generateSideWallUV: function (t, e, n, i, r, s) {
        ...
        return Math.abs(o - h) < 0.01
            ? [new nn(a, 1 - l), new nn(c, 1 - u), new nn(d, 1 - f), new nn(m, 1 - v)]
            : [new nn(o, 1 - l), new nn(h, 1 - u), new nn(p, 1 - f), new nn(g, 1 - v)];
    },
};
function Ml(t, e, n) {
    sr.call(this), (this.type = "ParametricGeometry"), (this.parameters = {func: t, slices: e, stacks: n});
    const i = [],
        r = [],
        s = [],
        a = [],
    ...
    this.setIndex(i), this.setAttribute("position", new Zi(r, 3)), this.setAttribute("normal", new Zi(s, 3)), this.setAttribute("uv", new Zi(a, 2));
}
(Ml.prototype = Object.create(sr.prototype)), (Ml.prototype.constructor = Ml);
class Sl extends sr {
    constructor(t, e = 12) {
        ...
        function l(t) {
            ...
            let c = l.shape;
            const h = l.holes;
            !1 === yl.isClockWise(c) && (c = c.reverse());
            for (let t = 0, e = h.length; t < e; t++) {
                const e = h[t];
                !0 === yl.isClockWise(e) && (h[t] = e.reverse());
            }
            const u = yl.triangulateShape(c, h);
            for (let t = 0, e = h.length; t < e; t++) {
                const e = h[t];
                c = c.concat(e);
            }
...
(class extends Ri {
    constructor(t) {
        super(), (this.type = "ShadowMaterial"), (this.color = new zi(0)), (this.transparent = !0), this.setValues(t);
    }
    copy(t) {
...
function Tl(t) {
    El.call(this),
        ...
        (this.clearcoatNormalScale = new nn(1, 1)),
        ...
        Object.defineProperty(this, "ior", {
            ...
            set: function (t) {
                this.reflectivity = en.clamp((2.5 * (t - 1)) / (t + 1), 0, 1);
            },
        }),
        (this.sheen = null),
        (this.transmission = 0),
...
((class extends Pr {
    ...
    (El.prototype = Object.create(Ri.prototype)),
    ...
    (Tl.prototype.copy = function (t) {
        return (
            ...
            (this.reflectivity = t.reflectivity),
            t.sheen ? (this.sheen = (this.sheen || new zi()).copy(t.sheen)) : (this.sheen = null),
...
Ll.prototype.isMeshPhongMaterial = !0;
(class extends Ri {
    constructor(t) {
        super(),
            (this.defines = {TOON: ""}),
...
const Al = {
    ...
    subclip: function (t, e, n, i, r = 30) {
        ...
        for (let t = 0; t < s.tracks.length; ++t) {
            ...
            0 !== l.length && ((e.times = Al.convertArray(l, e.times.constructor)), (e.values = Al.convertArray(c, e.values.constructor)), a.push(e));
        }
        s.tracks = a;
        let o = 1 / 0;
        ...
        for (let e = 0; e < r; ++e) {
            ...
            if (s <= i.times[0]) {
                ...
                const t = i.createInterpolant(),
                    e = o,
                    n = l - o;
                t.evaluate(s), (d = Al.arraySlice(t.resultBuffer, e, n));
            }
            if ("quaternion" === r) {
            ...
            for (let t = 0; t < p; ++t) {
                const e = t * h + c;
                if ("quaternion" === r) dn.multiplyQuaternionsFlat(a.values, e, d, 0, a.values, e);
                else {
                    const t = h - 2 * c;
...
function Cl(t, e, n, i) {
    Rl.call(this, t, e, n, i), (this._weightPrev = -0), (this._offsetPrev = -0), (this._weightNext = -0), (this._offsetNext = -0);
}
function Pl(t, e, n, i) {
    Rl.call(this, t, e, n, i);
}
function Dl(t, e, n, i) {
    Rl.call(this, t, e, n, i);
}
Object.assign(Rl.prototype, {
    ...
    Object.assign(Rl.prototype, {beforeStart_: Rl.prototype.copySampleValue_, afterEnd_: Rl.prototype.copySampleValue_}),
    (Cl.prototype = Object.assign(Object.create(Rl.prototype), {
        constructor: Cl,
        DefaultSettings_: {endingStart: De, endingEnd: De},
    ...
    (Pl.prototype = Object.assign(Object.create(Rl.prototype), {
        constructor: Pl,
        interpolate_: function (t, e, n, i) {
            const r = this.resultBuffer,
                s = this.sampleValues,
...
class Nl {
    ...
    static toJSON(t) {
        ...
        if (e.toJSON !== this.toJSON) n = e.toJSON(t);
            ...
            n = {name: t.name, times: Al.convertArray(t.times, Array), values: Al.convertArray(t.values, Array)};
    ...
    trim(t, e) {
        ...
        if ((++s, 0 !== r || s !== i)) {
            ...
            (this.times = Al.arraySlice(n, r, s)), (this.values = Al.arraySlice(this.values, r * t, s * t));
        }
        return this;
    }
    validate() {
    ...
    optimize() {
        const t = Al.arraySlice(this.times),
            e = Al.arraySlice(this.values),
            n = this.getValueSize(),
        ...
        return (
            s !== t.length
                ? ((this.times = Al.arraySlice(t, 0, s)), (this.values = Al.arraySlice(e, 0, s * n)))
                : ((this.times = t), (this.values = e)),
            this
        );
    }
    clone() {
        const t = Al.arraySlice(this.times, 0),
            e = Al.arraySlice(this.values, 0),
            n = new (0, this.constructor)(this.name, t, e);
        return (n.createInterpolant = this.createInterpolant), n;
    }
}
(Nl.prototype.TimeBufferType = Float32Array), (Nl.prototype.ValueBufferType = Float32Array), (Nl.prototype.DefaultInterpolation = Ce);
class Il extends Nl {}
(Il.prototype.ValueTypeName = "bool"),
    (Il.prototype.ValueBufferType = Array),
    (Il.prototype.DefaultInterpolation = Re),
...
(zl.prototype.ValueTypeName = "number"),
    (Hl.prototype = Object.assign(Object.create(Rl.prototype), {
        constructor: Hl,
        interpolate_: function (t, e, n, i) {
            const r = this.resultBuffer,
                s = this.sampleValues,
                ...
                o = (n - e) / (i - e);
            let l = t * a;
            for (let t = l + a; l !== t; l += 4) dn.slerpFlat(r, 0, s, l - a, s, l, o);
            return r;
        },
    }));
class Bl extends Nl {
...
(Bl.prototype.ValueTypeName = "quaternion"), (Bl.prototype.DefaultInterpolation = Ce), (Bl.prototype.InterpolantFactoryMethodSmooth = void 0);
class Fl extends Nl {}
(Fl.prototype.ValueTypeName = "string"),
    (Fl.prototype.ValueBufferType = Array),
    (Fl.prototype.DefaultInterpolation = Re),
...
class Gl {
    ...
    static parse(t) {
        const e = [],
            n = t.tracks,
            i = 1 / (t.fps || 1);
        for (let t = 0, r = n.length; t !== r; ++t) e.push(kl(n[t]).scale(i));
    ...
    static toJSON(t) {
        ...
        for (let t = 0, i = n.length; t !== i; ++t) e.push(Nl.toJSON(n[t]));
        return i;
    }
    static CreateFromMorphTargetSequence(t, e, n, i) {
        ...
        for (let t = 0; t < r; t++) {
            ...
            const l = Al.getKeyframeOrder(a);
            (a = Al.sortedArray(a, 1, l)),
                (o = Al.sortedArray(o, 1, l)),
    ...
    static parseAnimation(t, e) {
        ...
        const n = function (t, e, n, i, r) {
                if (0 !== n.length) {
                    const s = [],
                        a = [];
                    Al.flattenJSON(n, s, a, i), 0 !== s.length && r.push(new t(e, s, a));
                }
            },
            i = [],
            r = t.name || "default",
        ...
        for (let t = 0; t < l.length; t++) {
            ...
            if (r && 0 !== r.length)
                if (r[0].morphTargets) {
                    ...
                    n(Ul, s + ".position", r, "pos", i), n(Bl, s + ".quaternion", r, "rot", i), n(Ul, s + ".scale", r, "scl", i);
                }
        }
...
function kl(t) {
    ...
    if (void 0 === t.times) {
        const e = [],
            n = [];
        Al.flattenJSON(t.keys, e, n, "value"), (t.times = e), (t.values = n);
    }
...
(Xl.prototype = Object.assign(Object.create(jl.prototype), {
    ...
    load: function (t, e, n, i) {
        ...
        if (void 0 !== ql[t]) return void ql[t].push({onLoad: e, onProgress: n, onError: i});
        ...
        if (a) {
            ...
            (ql[t] = []),
                ql[t].push({onLoad: e, onProgress: n, onError: i}),
                ...
                o.addEventListener(
                    ...
                    function (e) {
                        const n = this.response,
                            i = ql[t];
                        if ((delete ql[t], 200 === this.status || 0 === this.status)) {
    ...
    (Yl.prototype = Object.assign(Object.create(jl.prototype), {
        constructor: Yl,
        load: function (t, e, n, i) {
            const r = this,
                s = [],
                a = new qo(),
                o = new Xl(this.manager);
                ...
                o.load(
                    ...
                    function (t) {
                        ...
                        (s[c] = {width: n.width, height: n.height, format: n.format, mipmaps: n.mipmaps}),
                            (l += 1),
                            6 === l &&
                                (1 === n.mipmapCount && (a.minFilter = mt), (a.image = s), (a.format = n.format), (a.needsUpdate = !0), e && e(a));
                    },
                    n,
                    i
                );
...
class Zl extends jl {
    ...
    load(t, e, n, i) {
        ...
        function o() {
            a.removeEventListener("load", o, !1), a.removeEventListener("error", l, !1), Vl.add(t, this), e && e(this), r.manager.itemEnd(t);
        }
        function l(e) {
...
(Ql.prototype = Object.assign(Object.create(jl.prototype), {
            ...
            a.load(
                ...
                function (t) {
                    ...
                    n &&
                        ...
                        (s.wrapS = void 0 !== n.wrapS ? n.wrapS : ht),
                        (s.wrapT = void 0 !== n.wrapT ? n.wrapT : ht),
                        ...
                        void 0 !== n.mipmaps && ((s.mipmaps = n.mipmaps), (s.minFilter = vt)),
            ...
            return (
                ...
                s.load(
                    ...
                    function (n) {
                        ...
                        (r.format = i ? Pt : Dt), (r.needsUpdate = !0), void 0 !== e && e(r);
                    },
                    n,
                    i
                ),
    ...
    Object.assign($l.prototype, {
        ...
        computeFrenetFrames: function (t, e) {
            ...
            for (let e = 0; e <= t; e++) {
                const n = e / t;
                (i[e] = this.getTangentAt(n, new pn())), i[e].normalize();
            }
            (r[0] = new pn()), (s[0] = new pn());
            ...
            for (let e = 1; e <= t; e++) {
                if (((r[e] = r[e - 1].clone()), (s[e] = s[e - 1].clone()), a.crossVectors(i[e - 1], i[e]), a.length() > Number.EPSILON)) {
                    a.normalize();
                    const t = Math.acos(en.clamp(i[e - 1].dot(i[e]), -1, 1));
                    r[e].applyMatrix4(o.makeRotationAxis(a, t));
                }
                s[e].crossVectors(i[e], r[e]);
            }
            if (!0 === e) {
                let e = Math.acos(en.clamp(r[0].dot(r[t]), -1, 1));
...
class oc extends $l {
    ...
    getPoint(t, e = new pn()) {
        ...
        this.closed ? (l += l > 0 ? 0 : (Math.floor(Math.abs(l) / r) + 1) * r) : 0 === c && l === r - 1 && ((l = r - 2), (c = 1)),
            this.closed || l > 0 ? (a = i[(l - 1) % r]) : (ic.subVectors(i[0], i[1]).add(i[0]), (a = ic));
        const h = i[l % r],
            u = i[(l + 1) % r];
        if (
            (this.closed || l + 2 < r ? (o = i[(l + 2) % r]) : (ic.subVectors(i[r - 1], i[r - 2]).add(i[r - 1]), (o = ic)),
...
uc.prototype.isCubicBezierCurve = !0;
class dc extends $l {
    constructor(t = new pn(), e = new pn(), n = new pn(), i = new pn()) {
    ...
    getPoint(t, e = new pn()) {
        const n = e,
            ...
            s = this.v2,
            a = this.v3;
        return n.set(hc(t, i.x, r.x, s.x, a.x), hc(t, i.y, r.y, s.y, a.y), hc(t, i.z, r.z, s.z, a.z)), n;
    }
    copy(t) {
        return super.copy(t), this.v0.copy(t.v0), this.v1.copy(t.v1), this.v2.copy(t.v2), this.v3.copy(t.v3), this;
    }
...
class mc extends $l {
    ...
    getPoint(t, e = new pn()) {
        const n = e,
            ...
            r = this.v1,
            s = this.v2;
        return n.set(cc(t, i.x, r.x, s.x), cc(t, i.y, r.y, s.y), cc(t, i.z, r.z, s.z)), n;
    }
    copy(t) {
        return super.copy(t), this.v0.copy(t.v0), this.v1.copy(t.v1), this.v2.copy(t.v2), this;
    }
...
mc.prototype.isQuadraticBezierCurve3 = !0;
class gc extends $l {
    constructor(t = []) {
...
class xc extends yc {
    constructor(t) {
        super(), (this.type = "Path"), (this.currentPoint = new nn()), t && this.setFromPoints(t);
    }
    setFromPoints(t) {
    ...
    lineTo(t, e) {
        const n = new pc(this.currentPoint.clone(), new nn(t, e));
        return this.curves.push(n), this.currentPoint.set(t, e), this;
    }
    quadraticCurveTo(t, e, n, i) {
        const r = new fc(this.currentPoint.clone(), new nn(t, e), new nn(n, i));
        return this.curves.push(r), this.currentPoint.set(n, i), this;
    }
    bezierCurveTo(t, e, n, i, r, s) {
        const a = new uc(this.currentPoint.clone(), new nn(t, e), new nn(n, i), new nn(r, s));
...
class _c extends xc {
    constructor(t) {
        super(t), (this.uuid = en.generateUUID()), (this.type = "Shape"), (this.holes = []);
    }
    getPointsHoles(t) {
        const e = [];
...
class bc extends di {
    constructor(t, e = 1) {
        super(), (this.type = "Light"), (this.color = new zi(t)), (this.intensity = e);
    }
    copy(t) {
...
(class extends bc {
    constructor(t, e, n) {
        super(t, n), (this.type = "HemisphereLight"), this.position.copy(di.DefaultUp), this.updateMatrix(), (this.groundColor = new zi(e));
    }
    copy(t) {
        return bc.prototype.copy.call(this, t), this.groundColor.copy(t.groundColor), this;
    }
...
class Ec {
    ...
    updateMatrices(t) {
        ...
        Mc.setFromMatrixPosition(t.matrixWorld),
            e.position.copy(Mc),
            Sc.setFromMatrixPosition(t.target.matrixWorld),
            e.lookAt(Sc),
            e.updateMatrixWorld(),
            wc.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
...
class Tc extends Ec {
    ...
    updateMatrices(t) {
        const e = this.camera,
            n = 2 * en.RAD2DEG * t.angle * this.focus,
...
(class extends bc {
    constructor(t, e, n = 0, i = Math.PI / 3, r = 0, s = 1) {
        super(t, e),
            (this.type = "SpotLight"),
            this.position.copy(di.DefaultUp),
            this.updateMatrix(),
            (this.target = new di()),
            (this.distance = n),
            (this.angle = i),
...
class Cc extends Ec {
    ...
    updateMatrices(t, e = 0) {
        ...
        Ac.setFromMatrixPosition(t.matrixWorld),
            ...
            n.lookAt(Rc),
            n.updateMatrixWorld(),
            i.makeTranslation(-Ac.x, -Ac.y, -Ac.z),
            Lc.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse),
...
Pc.prototype.isOrthographicCamera = !0;
class Dc extends Ec {
    constructor() {
        super(new Pc(-5, 5, 5, -5, 0.5, 500));
    }
}
...
class Nc {
    constructor() {
        this.coefficients = [];
        for (let t = 0; t < 9; t++) this.coefficients.push(new pn());
    }
    set(t) {
...
function zc() {
    sr.call(this), (this.type = "InstancedBufferGeometry"), (this.instanceCount = 1 / 0);
}
function Hc(t, e, n, i) {
    "number" == typeof n &&
...
(zc.prototype = Object.assign(Object.create(sr.prototype), {
    constructor: zc,
    isInstancedBufferGeometry: !0,
    copy: function (t) {
        return sr.prototype.copy.call(this, t), (this.instanceCount = t.instanceCount), this;
    },
    clone: function () {
        return new this.constructor().copy(this);
    },
    ...
    (Hc.prototype = Object.assign(Object.create(Ui.prototype), {
        constructor: Hc,
        isInstancedBufferAttribute: !0,
        copy: function (t) {
            return Ui.prototype.copy.call(this, t), (this.meshPerAttribute = t.meshPerAttribute), this;
        },
        toJSON: function () {
            const t = Ui.prototype.toJSON.call(this);
            return (t.meshPerAttribute = this.meshPerAttribute), (t.isInstancedBufferAttribute = !0), t;
        },
    })),
    (Bc.prototype = Object.assign(Object.create(jl.prototype), {
        constructor: Bc,
...
class Fc {
    ...
    _slerp(t, e, n, i) {
        dn.slerpFlat(t, e, t, e, t, n, i);
    }
    _slerpAdditive(t, e, n, i, r) {
        const s = this._workIndex * r;
        dn.multiplyQuaternionsFlat(t, s, t, e, t, n), dn.slerpFlat(t, e, t, e, t, s, i);
    }
    _lerp(t, e, n, i, r) {
        const s = 1 - i;
        for (let a = 0; a !== r; ++a) {
...
const Uc = "\\[\\]\\.:\\/",
    ...
    kc = "[^" + Uc + "]",
    Vc = "[^" + Uc.replace("\\.", "") + "]",
    Wc = /((?:WC+[\/:])*)/.source.replace("WC", kc),
    jc = /(WCOD+)?/.source.replace("WCOD", Vc),
    qc = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", kc),
    Xc = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", kc),
    Yc = new RegExp("^" + Wc + jc + qc + Xc + "$"),
...
function Qc(t, e, n) {
    (this.path = e), (this.parsedPath = n || Qc.parseTrackName(e)), (this.node = Qc.findNode(t, this.parsedPath.nodeName) || t), (this.rootNode = t);
}
Object.assign(Jc.prototype, {
    ...
    Object.assign(Qc, {
        ...
        parseTrackName: function (t) {
            ...
            if (void 0 !== i && -1 !== i) {
                ...
                -1 !== Zc.indexOf(t) && ((n.nodeName = n.nodeName.substring(0, i)), (n.objectName = t));
            }
    ...
    Object.assign(Qc.prototype, {_getValue_unbound: Qc.prototype.getValue, _setValue_unbound: Qc.prototype.setValue});
class Kc {
    ...
    _updateTime(t) {
        ...
        if (2200 === n) {
            ...
            if (
                (-1 === r && (t >= 0 ? ((r = 0), this._setEndings(!0, 0 === this.repetitions, s)) : this._setEndings(0 === this.repetitions, !0, s)),
                i >= e || i < 0)
            ) {
    ...
    _setEndings(t, e, n) {
        ...
        n
            ? ((i.endingStart = Ne), (i.endingEnd = Ne))
            : ((i.endingStart = t ? (this.zeroSlopeAtStart ? Ne : De) : Ie), (i.endingEnd = e ? (this.zeroSlopeAtEnd ? Ne : De) : Ie));
    }
...
(class extends Ke {
    ...
    _bindAction(t, e) {
        ...
        for (let t = 0; t !== r; ++t) {
            ...
            if (void 0 !== h) s[t] = h;
                ...
                (h = new Fc(Qc.create(n, l, i), r.ValueTypeName, r.getValueSize())),
                    ++h.referenceCount,
    ...
    _lendControlInterpolant() {
        ...
        return (
            void 0 === n &&
                ((n = new Pl(new Float32Array(2), new Float32Array(2), 1, this._controlInterpolantsResultBuffer)), (n.__cacheIndex = e), (t[e] = n)),
            n
        );
    }
    ...
    clipAction(t, e, n) {
        const i = e || this._root,
            r = i.uuid;
        let s = "string" == typeof t ? Gl.findByName(i, t) : t;
        const a = null !== s ? s.uuid : t,
            o = this._actionsByClip[a];
        let l = null;
        if ((void 0 === n && (n = null !== s ? s.blendMode : Oe), void 0 !== o)) {
            const t = o.actionByRoot[r];
            if (void 0 !== t && t.blendMode === n) return t;
            (l = o.knownActions[0]), null === s && (s = l._clip);
        }
        if (null === s) return null;
        const c = new Kc(this, s, e, n);
        return this._bindAction(c, l), this._addInactiveAction(c, a, r), c;
    }
    existingAction(t, e) {
        const n = e || this._root,
            i = n.uuid,
            r = "string" == typeof t ? Gl.findByName(n, t) : t,
            s = r ? r.uuid : t,
...
class $c {
    ...
    clone() {
        return new $c(void 0 === this.value.clone ? this.value : this.value.clone());
    }
}
function th(t, e, n) {
    Ka.call(this, t, e), (this.meshPerAttribute = n || 1);
}
function eh(t, e, n, i, r) {
    (this.buffer = t), (this.type = e), (this.itemSize = n), (this.elementSize = i), (this.count = r), (this.version = 0);
}
function nh(t, e, n = 0, i = 1 / 0) {
    (this.ray = new Un(t, e)),
        (this.near = n),
        (this.far = i),
        (this.camera = null),
...
function rh(t, e, n, i) {
    if ((t.layers.test(e.layers) && t.raycast(e, n), !0 === i)) {
        const i = t.children;
        for (let t = 0, r = i.length; t < r; t++) rh(i[t], e, n, !0);
    }
}
(th.prototype = Object.assign(Object.create(Ka.prototype), {
    ...
    copy: function (t) {
        return Ka.prototype.copy.call(this, t), (this.meshPerAttribute = t.meshPerAttribute), this;
    },
    clone: function (t) {
        const e = Ka.prototype.clone.call(this, t);
        return (e.meshPerAttribute = this.meshPerAttribute), e;
    },
    toJSON: function (t) {
        const e = Ka.prototype.toJSON.call(this, t);
    ...
    Object.assign(nh.prototype, {
        ...
        intersectObject: function (t, e = !1, n = []) {
            return rh(t, this, n, e), n.sort(ih), n;
        },
        intersectObjects: function (t, e = !1, n = []) {
            for (let i = 0, r = t.length; i < r; i++) rh(t[i], this, n, e);
            return n.sort(ih), n;
        },
    });
class sh {
    ...
    setFromCartesianCoords(t, e, n) {
        return (
            ...
            0 === this.radius
                ...
                : ((this.theta = Math.atan2(t, n)), (this.phi = Math.acos(en.clamp(e / this.radius, -1, 1)))),
            this
        );
    }
    clone() {
...
(ah.prototype = Object.create(di.prototype)), (ah.prototype.constructor = ah), (ah.prototype.isImmediateRenderObject = !0);
const oh = new pn(),
    lh = new Gn(),
    ch = new Gn();
function hh(t) {
...
class uh extends Bo {
    constructor(t = 1) {
        const e = [0, 0, 0, t, 0, 0, 0, 0, 0, 0, t, 0, 0, 0, 0, 0, 0, t],
            n = new sr();
        n.setAttribute("position", new Zi(e, 3)), n.setAttribute("color", new Zi([1, 0, 0, 1, 0.6, 0, 0, 1, 0, 0.6, 1, 0, 0, 0, 1, 0, 0.6, 1], 3));
        super(n, new Ro({vertexColors: !0, toneMapped: !1})), (this.type = "AxesHelper");
    }
}
const dh = new Float32Array(1);
new Int32Array(dh.buffer);
const ph = new Hi({side: g, depthWrite: !1, depthTest: !1});
new Mr(new Er(), ph),
    ...
    (xc.prototype.fromPoints = function (t) {
        return console.warn("THREE.Path: .fromPoints() has been renamed to .setFromPoints()."), this.setFromPoints(t);
    }),
    (class extends Bo {
        constructor(t = 10, e = 10, n = 4473924, i = 8947848) {
            (n = new zi(n)), (i = new zi(i));
            const r = e / 2,
                s = t / e,
                a = t / 2,
                o = [],
    ...
    (class extends Bo {
        constructor(t) {
            ...
            super(n, new Ro({vertexColors: !0, depthTest: !1, depthWrite: !1, toneMapped: !1, transparent: !0})),
    ...
    (jl.prototype.extractUrlBase = function (t) {
        return console.warn("THREE.Loader: .extractUrlBase() has been deprecated. Use THREE.LoaderUtils.extractUrlBase() instead."), Oc(t);
    }),
    (jl.Handlers = {
        add: function () {
    ...
    (gn.prototype.center = function (t) {
        return console.warn("THREE.Box3: .center() has been renamed to .getCenter()."), this.getCenter(t);
    }),
    (gn.prototype.empty = function () {
        return console.warn("THREE.Box3: .empty() has been renamed to .isEmpty()."), this.isEmpty();
    }),
    (gn.prototype.isIntersectionBox = function (t) {
        return console.warn("THREE.Box3: .isIntersectionBox() has been renamed to .intersectsBox()."), this.intersectsBox(t);
    }),
    (gn.prototype.isIntersectionSphere = function (t) {
        return console.warn("THREE.Box3: .isIntersectionSphere() has been renamed to .intersectsSphere()."), this.intersectsSphere(t);
    }),
    (gn.prototype.size = function (t) {
        return console.warn("THREE.Box3: .size() has been renamed to .getSize()."), this.getSize(t);
    }),
    (Dn.prototype.empty = function () {
        return console.warn("THREE.Sphere: .empty() has been renamed to .isEmpty()."), this.isEmpty();
    }),
    (Gr.prototype.setFromMatrix = function (t) {
        return console.warn("THREE.Frustum: .setFromMatrix() has been renamed to .setFromProjectionMatrix()."), this.setFromProjectionMatrix(t);
    }),
    (en.random16 = function () {
        return console.warn("THREE.Math: .random16() has been deprecated. Use Math.random() instead."), Math.random();
    }),
    (en.nearestPowerOfTwo = function (t) {
        return console.warn("THREE.Math: .nearestPowerOfTwo() has been renamed to .floorPowerOfTwo()."), en.floorPowerOfTwo(t);
    }),
    (en.nextPowerOfTwo = function (t) {
        return console.warn("THREE.Math: .nextPowerOfTwo() has been renamed to .ceilPowerOfTwo()."), en.ceilPowerOfTwo(t);
    }),
    (rn.prototype.flattenToArrayOffset = function (t, e) {
        return console.warn("THREE.Matrix3: .flattenToArrayOffset() has been deprecated. Use .toArray() instead."), this.toArray(t, e);
    }),
    (rn.prototype.multiplyVector3 = function (t) {
        return console.warn("THREE.Matrix3: .multiplyVector3() has been removed. Use vector.applyMatrix3( matrix ) instead."), t.applyMatrix3(this);
    }),
    (rn.prototype.multiplyVector3Array = function () {
        console.error("THREE.Matrix3: .multiplyVector3Array() has been removed.");
    }),
    (rn.prototype.applyToBufferAttribute = function (t) {
        return (
    ...
    (rn.prototype.getInverse = function (t) {
    ...
    (Gn.prototype.extractPosition = function (t) {
        return console.warn("THREE.Matrix4: .extractPosition() has been renamed to .copyPosition()."), this.copyPosition(t);
    }),
    (Gn.prototype.flattenToArrayOffset = function (t, e) {
        return console.warn("THREE.Matrix4: .flattenToArrayOffset() has been deprecated. Use .toArray() instead."), this.toArray(t, e);
    }),
    (Gn.prototype.getPosition = function () {
        return (
            console.warn("THREE.Matrix4: .getPosition() has been removed. Use Vector3.setFromMatrixPosition( matrix ) instead."),
            new pn().setFromMatrixColumn(this, 3)
        );
    }),
    (Gn.prototype.setRotationFromQuaternion = function (t) {
        return (
            console.warn("THREE.Matrix4: .setRotationFromQuaternion() has been renamed to .makeRotationFromQuaternion()."),
            this.makeRotationFromQuaternion(t)
        );
    }),
    (Gn.prototype.multiplyToArray = function () {
        console.warn("THREE.Matrix4: .multiplyToArray() has been removed.");
    }),
    (Gn.prototype.multiplyVector3 = function (t) {
        return console.warn("THREE.Matrix4: .multiplyVector3() has been removed. Use vector.applyMatrix4( matrix ) instead."), t.applyMatrix4(this);
    }),
    (Gn.prototype.multiplyVector4 = function (t) {
        return console.warn("THREE.Matrix4: .multiplyVector4() has been removed. Use vector.applyMatrix4( matrix ) instead."), t.applyMatrix4(this);
    }),
    (Gn.prototype.multiplyVector3Array = function () {
        console.error("THREE.Matrix4: .multiplyVector3Array() has been removed.");
    }),
    (Gn.prototype.rotateAxis = function (t) {
        console.warn("THREE.Matrix4: .rotateAxis() has been removed. Use Vector3.transformDirection( matrix ) instead."), t.transformDirection(this);
    }),
    (Gn.prototype.crossVector = function (t) {
        return console.warn("THREE.Matrix4: .crossVector() has been removed. Use vector.applyMatrix4( matrix ) instead."), t.applyMatrix4(this);
    }),
    (Gn.prototype.translate = function () {
        console.error("THREE.Matrix4: .translate() has been removed.");
    }),
    (Gn.prototype.rotateX = function () {
        console.error("THREE.Matrix4: .rotateX() has been removed.");
    }),
    (Gn.prototype.rotateY = function () {
        console.error("THREE.Matrix4: .rotateY() has been removed.");
    }),
    (Gn.prototype.rotateZ = function () {
        console.error("THREE.Matrix4: .rotateZ() has been removed.");
    }),
    (Gn.prototype.rotateByAxis = function () {
        console.error("THREE.Matrix4: .rotateByAxis() has been removed.");
    }),
    (Gn.prototype.applyToBufferAttribute = function (t) {
        return (
            console.warn("THREE.Matrix4: .applyToBufferAttribute() has been removed. Use attribute.applyMatrix4( matrix ) instead."),
            t.applyMatrix4(this)
        );
    }),
    (Gn.prototype.applyToVector3Array = function () {
        console.error("THREE.Matrix4: .applyToVector3Array() has been removed.");
    }),
    (Gn.prototype.makeFrustum = function (t, e, n, i, r, s) {
        return (
            console.warn("THREE.Matrix4: .makeFrustum() has been removed. Use .makePerspective( left, right, top, bottom, near, far ) instead."),
            this.makePerspective(t, e, i, n, r, s)
        );
    }),
    (Gn.prototype.getInverse = function (t) {
    ...
    (Li.barycoordFromPoint = function (t, e, n, i, r) {
        return console.warn("THREE.Triangle: .barycoordFromPoint() has been renamed to .getBarycoord()."), Li.getBarycoord(t, e, n, i, r);
    }),
    (Li.normal = function (t, e, n, i) {
        return console.warn("THREE.Triangle: .normal() has been renamed to .getNormal()."), Li.getNormal(t, e, n, i);
    }),
    (_c.prototype.extractAllPoints = function (t) {
        return console.warn("THREE.Shape: .extractAllPoints() has been removed. Use .extractPoints() instead."), this.extractPoints(t);
    }),
    (_c.prototype.extrude = function (t) {
        return console.warn("THREE.Shape: .extrude() has been removed. Use ExtrudeGeometry() instead."), new bl(this, t);
    }),
    (_c.prototype.makeGeometry = function (t) {
        return console.warn("THREE.Shape: .makeGeometry() has been removed. Use ShapeGeometry() instead."), new Sl(this, t);
    }),
    (nn.prototype.fromAttribute = function (t, e, n) {
        return console.warn("THREE.Vector2: .fromAttribute() has been renamed to .fromBufferAttribute()."), this.fromBufferAttribute(t, e, n);
    }),
    (nn.prototype.distanceToManhattan = function (t) {
        return console.warn("THREE.Vector2: .distanceToManhattan() has been renamed to .manhattanDistanceTo()."), this.manhattanDistanceTo(t);
    }),
    (nn.prototype.lengthManhattan = function () {
        return console.warn("THREE.Vector2: .lengthManhattan() has been renamed to .manhattanLength()."), this.manhattanLength();
    }),
    (pn.prototype.setEulerFromRotationMatrix = function () {
        console.error("THREE.Vector3: .setEulerFromRotationMatrix() has been removed. Use Euler.setFromRotationMatrix() instead.");
    }),
    (pn.prototype.setEulerFromQuaternion = function () {
        console.error("THREE.Vector3: .setEulerFromQuaternion() has been removed. Use Euler.setFromQuaternion() instead.");
    }),
    (pn.prototype.getPositionFromMatrix = function (t) {
        return console.warn("THREE.Vector3: .getPositionFromMatrix() has been renamed to .setFromMatrixPosition()."), this.setFromMatrixPosition(t);
    }),
    (pn.prototype.getScaleFromMatrix = function (t) {
        return console.warn("THREE.Vector3: .getScaleFromMatrix() has been renamed to .setFromMatrixScale()."), this.setFromMatrixScale(t);
    }),
    (pn.prototype.getColumnFromMatrix = function (t, e) {
        return console.warn("THREE.Vector3: .getColumnFromMatrix() has been renamed to .setFromMatrixColumn()."), this.setFromMatrixColumn(e, t);
    }),
    (pn.prototype.applyProjection = function (t) {
        return console.warn("THREE.Vector3: .applyProjection() has been removed. Use .applyMatrix4( m ) instead."), this.applyMatrix4(t);
    }),
    (pn.prototype.fromAttribute = function (t, e, n) {
        return console.warn("THREE.Vector3: .fromAttribute() has been renamed to .fromBufferAttribute()."), this.fromBufferAttribute(t, e, n);
    }),
    (pn.prototype.distanceToManhattan = function (t) {
        return console.warn("THREE.Vector3: .distanceToManhattan() has been renamed to .manhattanDistanceTo()."), this.manhattanDistanceTo(t);
    }),
    (pn.prototype.lengthManhattan = function () {
    ...
    (di.prototype.getChildByName = function (t) {
        return console.warn("THREE.Object3D: .getChildByName() has been renamed to .getObjectByName()."), this.getObjectByName(t);
    }),
    (di.prototype.renderDepth = function () {
        console.warn("THREE.Object3D: .renderDepth has been removed. Use .renderOrder, instead.");
    }),
    (di.prototype.translate = function (t, e) {
        return (
            console.warn("THREE.Object3D: .translate() has been removed. Use .translateOnAxis( axis, distance ) instead."), this.translateOnAxis(e, t)
        );
    }),
    (di.prototype.getWorldRotation = function () {
    ...
    Object.defineProperties(Ui.prototype, {
        ...
        dynamic: {
            get: function () {
                return console.warn("THREE.BufferAttribute: .dynamic has been deprecated. Use .usage instead."), this.usage === Je;
            },
            set: function () {
                console.warn("THREE.BufferAttribute: .dynamic has been deprecated. Use .usage instead."), this.setUsage(Je);
            },
        },
    }),
    (Ui.prototype.setDynamic = function (t) {
        return (
            console.warn("THREE.BufferAttribute: .setDynamic() has been deprecated. Use .setUsage() instead."),
            this.setUsage(!0 === t ? Je : Ze),
            this
        );
    }),
    (Ui.prototype.copyIndicesArray = function () {
        console.error("THREE.BufferAttribute: .copyIndicesArray() has been removed.");
    }),
    (Ui.prototype.setArray = function () {
        console.error("THREE.BufferAttribute: .setArray has been removed. Use BufferGeometry .setAttribute to replace/resize attribute buffers");
    }),
    (sr.prototype.addIndex = function (t) {
        console.warn("THREE.BufferGeometry: .addIndex() has been renamed to .setIndex()."), this.setIndex(t);
    }),
    (sr.prototype.addAttribute = function (t, e) {
        return (
            ...
            (e && e.isBufferAttribute) || (e && e.isInterleavedBufferAttribute)
                ...
                : (console.warn("THREE.BufferGeometry: .addAttribute() now expects ( name, attribute )."),
                  this.setAttribute(t, new Ui(arguments[1], arguments[2])))
        );
    }),
    (sr.prototype.addDrawCall = function (t, e, n) {
        void 0 !== n && console.warn("THREE.BufferGeometry: .addDrawCall() no longer supports indexOffset."),
            console.warn("THREE.BufferGeometry: .addDrawCall() is now .addGroup()."),
            this.addGroup(t, e);
    }),
    (sr.prototype.clearDrawCalls = function () {
        console.warn("THREE.BufferGeometry: .clearDrawCalls() is now .clearGroups()."), this.clearGroups();
    }),
    (sr.prototype.computeOffsets = function () {
        console.warn("THREE.BufferGeometry: .computeOffsets() has been removed.");
    }),
    (sr.prototype.removeAttribute = function (t) {
        return console.warn("THREE.BufferGeometry: .removeAttribute() has been renamed to .deleteAttribute()."), this.deleteAttribute(t);
    }),
    (sr.prototype.applyMatrix = function (t) {
    ...
    Object.defineProperties(Ka.prototype, {
        dynamic: {
            get: function () {
                return console.warn("THREE.InterleavedBuffer: .length has been deprecated. Use .usage instead."), this.usage === Je;
            },
            set: function (t) {
    ...
    (Ka.prototype.setDynamic = function (t) {
        return (
    ...
    (Ka.prototype.setArray = function () {
    ...
    (Ja.prototype.getMaxAnisotropy = function () {
        return (
            console.warn("THREE.WebGLRenderer: .getMaxAnisotropy() is now .capabilities.getMaxAnisotropy()."), this.capabilities.getMaxAnisotropy()
        );
    }),
    ...
    Object.defineProperties(Ja.prototype, {
        ...
        gammaInput: {
            get: function () {
                return (
                    console.warn("THREE.WebGLRenderer: .gammaInput has been removed. Set the encoding for textures via Texture.encoding instead."), !1
                );
            },
            set: function () {
    ...
    (Or.prototype.updateCubeMap = function (t, e) {
    ...
    (an.loadTexture = function (t, e, n, i) {
    ...
    (an.loadTextureCube = function (t, e, n, i) {
    ...
    "undefined" != typeof __THREE_DEVTOOLS__ && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register", {detail: {revision: "126"}})),
    "undefined" != typeof window &&
        (window.__THREE__ ? console.warn("WARNING: Multiple instances of Three.js being imported.") : (window.__THREE__ = "126"));
var fh = function (t, e) {
    var c, h, u, d, p, f;
    void 0 === e && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'),
        ...
        (this.mouseButtons = {LEFT: n, MIDDLE: i, RIGHT: r}),
        (this.touches = {ONE: s, TWO: o}),
        ...
        (this.update =
            ((c = new pn()),
            (h = new dn().setFromUnitVectors(t.up, new pn(0, 1, 0))),
            (u = h.clone().invert()),
            (d = new pn()),
            (p = new dn()),
            (f = 2 * Math.PI),
            function () {
                var t = m.object.position;
                c.copy(t).sub(m.target),
                    c.applyQuaternion(h),
                    w.setFromVector3(c),
                    m.autoRotate && _ === x.NONE && H(((2 * Math.PI) / 60 / 60) * m.autoRotateSpeed),
                    m.enableDamping
                        ? ((w.theta += M.theta * m.dampingFactor), (w.phi += M.phi * m.dampingFactor))
                        : ((w.theta += M.theta), (w.phi += M.phi));
                var e = m.minAzimuthAngle,
                    n = m.maxAzimuthAngle;
                return (
                    isFinite(e) &&
                        isFinite(n) &&
                        (e < -Math.PI ? (e += f) : e > Math.PI && (e -= f),
                        n < -Math.PI ? (n += f) : n > Math.PI && (n -= f),
                        (w.theta = e <= n ? Math.max(e, Math.min(n, w.theta)) : w.theta > (e + n) / 2 ? Math.max(e, w.theta) : Math.min(n, w.theta))),
                    (w.phi = Math.max(m.minPolarAngle, Math.min(m.maxPolarAngle, w.phi))),
                    w.makeSafe(),
                    (w.radius *= S),
                    (w.radius = Math.max(m.minDistance, Math.min(m.maxDistance, w.radius))),
                    !0 === m.enableDamping ? m.target.addScaledVector(E, m.dampingFactor) : m.target.add(E),
                    c.setFromSpherical(w),
                    c.applyQuaternion(u),
                    t.copy(m.target).add(c),
                    m.object.lookAt(m.target),
                    !0 === m.enableDamping
                        ? ((M.theta *= 1 - m.dampingFactor), (M.phi *= 1 - m.dampingFactor), E.multiplyScalar(1 - m.dampingFactor))
                        : (M.set(0, 0, 0), E.set(0, 0, 0)),
                    (S = 1),
                    !!(T || d.distanceToSquared(m.object.position) > b || 8 * (1 - p.dot(m.object.quaternion)) > b) &&
                        (m.dispatchEvent(g), d.copy(m.object.position), p.copy(m.object.quaternion), (T = !1), !0)
                );
            })),
        (this.dispose = function () {
            m.domElement.removeEventListener("contextmenu", ot),
                m.domElement.removeEventListener("pointerdown", $),
                m.domElement.removeEventListener("wheel", nt),
                m.domElement.removeEventListener("touchstart", rt),
                m.domElement.removeEventListener("touchend", at),
                m.domElement.removeEventListener("touchmove", st),
                m.domElement.ownerDocument.removeEventListener("pointermove", tt),
                m.domElement.ownerDocument.removeEventListener("pointerup", et),
                null !== m._domElementKeyEvents && m._domElementKeyEvents.removeEventListener("keydown", it);
        });
    var m = this,
        g = {type: "change"},
        v = {type: "start"},
        y = {type: "end"},
        x = {NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_PAN: 4, TOUCH_DOLLY_PAN: 5, TOUCH_DOLLY_ROTATE: 6},
        _ = x.NONE,
        b = 1e-6,
        w = new sh(),
        M = new sh(),
    ...
    var F,
        U =
            ((F = new pn()),
            function (t, e) {
                F.setFromMatrixColumn(e, 0), F.multiplyScalar(-t), E.add(F);
            }),
        G = (function () {
            var t = new pn();
            return function (e, n) {
                !0 === m.screenSpacePanning ? t.setFromMatrixColumn(n, 1) : (t.setFromMatrixColumn(n, 0), t.crossVectors(m.object.up, t)),
                    t.multiplyScalar(e),
                    E.add(t);
            };
        })(),
        k = (function () {
            ...
            return function (e, n) {
                ...
                if (m.object.isPerspectiveCamera) {
                    ...
                    t.copy(r).sub(m.target);
                    var s = t.length();
                    (s *= Math.tan(((m.object.fov / 2) * Math.PI) / 180)),
                        U((2 * e * s) / i.clientHeight, m.object.matrix),
                        G((2 * n * s) / i.clientHeight, m.object.matrix);
                } else
                    m.object.isOrthographicCamera
                        ? (U((e * (m.object.right - m.object.left)) / m.object.zoom / i.clientWidth, m.object.matrix),
                          G((n * (m.object.top - m.object.bottom)) / m.object.zoom / i.clientHeight, m.object.matrix))
    ...
    function V(t) {
        m.object.isPerspectiveCamera
            ? (S /= t)
            : m.object.isOrthographicCamera
              ? ((m.object.zoom = Math.max(m.minZoom, Math.min(m.maxZoom, m.object.zoom * t))), m.object.updateProjectionMatrix(), (T = !0))
    ...
    function J(t) {
        ...
        R.subVectors(A, L).multiplyScalar(m.rotateSpeed);
        var i = m.domElement;
        H((2 * Math.PI * R.x) / i.clientHeight), B((2 * Math.PI * R.y) / i.clientHeight), L.copy(A);
    }
    function Q(t) {
        if (1 == t.touches.length) P.set(t.touches[0].pageX, t.touches[0].pageY);
        else {
            var e = 0.5 * (t.touches[0].pageX + t.touches[1].pageX),
                n = 0.5 * (t.touches[0].pageY + t.touches[1].pageY);
            P.set(e, n);
        }
        D.subVectors(P, C).multiplyScalar(m.panSpeed), k(D.x, D.y), C.copy(P);
    }
    function K(t) {
        var e = t.touches[0].pageX - t.touches[1].pageX,
            n = t.touches[0].pageY - t.touches[1].pageY,
            i = Math.sqrt(e * e + n * n);
        I.set(0, i), O.set(0, Math.pow(I.y / N.y, m.zoomSpeed)), V(O.y), N.copy(I);
    }
    function $(t) {
        if (!1 !== m.enabled)
            switch (t.pointerType) {
                ...
                case "pen":
                    !(function (t) {
                        var e;
                        switch ((t.preventDefault(), m.domElement.focus ? m.domElement.focus() : window.focus(), t.button)) {
                            case 0:
                                e = m.mouseButtons.LEFT;
                                break;
                            case 1:
                                e = m.mouseButtons.MIDDLE;
                                break;
                            case 2:
                                e = m.mouseButtons.RIGHT;
                                break;
                            default:
                                e = -1;
                        }
                        ...
                        _ !== x.NONE &&
                            (m.domElement.ownerDocument.addEventListener("pointermove", tt),
                            m.domElement.ownerDocument.addEventListener("pointerup", et),
                            m.dispatchEvent(v));
                    })(t);
            }
    }
            ...
            switch (t.pointerType) {
                ...
                case "pen":
                    !(function (t) {
                        ...
                        switch ((t.preventDefault(), _)) {
                            case x.ROTATE:
                                if (!1 === m.enableRotate) return;
                                !(function (t) {
                                    A.set(t.clientX, t.clientY), R.subVectors(A, L).multiplyScalar(m.rotateSpeed);
                                    var e = m.domElement;
                                    H((2 * Math.PI * R.x) / e.clientHeight), B((2 * Math.PI * R.y) / e.clientHeight), L.copy(A), m.update();
                                })(t);
                                break;
                            case x.DOLLY:
                                if (!1 === m.enableZoom) return;
                                !(function (t) {
                                    I.set(t.clientX, t.clientY), O.subVectors(I, N), O.y > 0 ? V(z()) : O.y < 0 && W(z()), N.copy(I), m.update();
                                })(t);
                                break;
                            case x.PAN:
                                if (!1 === m.enablePan) return;
                                !(function (t) {
                                    P.set(t.clientX, t.clientY), D.subVectors(P, C).multiplyScalar(m.panSpeed), k(D.x, D.y), C.copy(P), m.update();
                                })(t);
                        }
                    })(t);
            }
    ...
    function nt(t) {
        !1 === m.enabled ||
            ...
            m.dispatchEvent(v),
            (function (t) {
                t.deltaY < 0 ? W(z()) : t.deltaY > 0 && V(z()), m.update();
            })(t),
            m.dispatchEvent(y));
    }
    function it(t) {
        !1 !== m.enabled &&
            ...
            (function (t) {
                ...
                switch (t.keyCode) {
                    case m.keys.UP:
                        k(0, m.keyPanSpeed), (e = !0);
                        break;
                    case m.keys.BOTTOM:
                        k(0, -m.keyPanSpeed), (e = !0);
                        break;
                    case m.keys.LEFT:
                        k(m.keyPanSpeed, 0), (e = !0);
                        break;
                    case m.keys.RIGHT:
                        k(-m.keyPanSpeed, 0), (e = !0);
                }
                e && (t.preventDefault(), m.update());
            })(t);
    }
    function rt(t) {
        if (!1 !== m.enabled) {
                ...
                case 2:
                    switch (m.touches.TWO) {
                        case o:
                            ...
                            !(function (t) {
                                m.enableZoom && Z(t), m.enablePan && Y(t);
                            })(t),
                                (_ = x.TOUCH_DOLLY_PAN);
                            break;
                        case l:
                            ...
                            !(function (t) {
                                m.enableZoom && Z(t), m.enableRotate && X(t);
                            })(t),
                                (_ = x.TOUCH_DOLLY_ROTATE);
                            break;
                        default:
                            _ = x.NONE;
                    }
            ...
            _ !== x.NONE && m.dispatchEvent(v);
        }
    }
    function st(t) {
        if (!1 !== m.enabled)
            switch ((t.preventDefault(), t.stopPropagation(), _)) {
                case x.TOUCH_ROTATE:
                    if (!1 === m.enableRotate) return;
                    J(t), m.update();
                    break;
                ...
                case x.TOUCH_DOLLY_PAN:
                    if (!1 === m.enableZoom && !1 === m.enablePan) return;
                    !(function (t) {
                        m.enableZoom && K(t), m.enablePan && Q(t);
                    })(t),
                        m.update();
                    break;
                case x.TOUCH_DOLLY_ROTATE:
                    if (!1 === m.enableZoom && !1 === m.enableRotate) return;
                    !(function (t) {
                        m.enableZoom && K(t), m.enableRotate && J(t);
                    })(t),
                        m.update();
                    break;
                default:
    ...
    function at(t) {
        !1 !== m.enabled && (m.dispatchEvent(y), (_ = x.NONE));
    }
    function ot(t) {
        !1 !== m.enabled && t.preventDefault();
    }
    m.domElement.addEventListener("contextmenu", ot),
        m.domElement.addEventListener("pointerdown", $),
        m.domElement.addEventListener("wheel", nt),
        m.domElement.addEventListener("touchstart", rt),
        m.domElement.addEventListener("touchend", at),
        m.domElement.addEventListener("touchmove", st),
        this.update();
};
(fh.prototype = Object.create(Ke.prototype)).constructor = fh;
var mh = function (t, e) {
    fh.call(this, t, e),
        (this.screenSpacePanning = !1),
        (this.mouseButtons.LEFT = r),
        (this.mouseButtons.RIGHT = n),
        (this.touches.ONE = a),
        (this.touches.TWO = l);
};
(mh.prototype = Object.create(Ke.prototype)).constructor = mh;
const gh = new gi(),
    vh = new nh(),
    yh = new nn(),
    xh = new pn(),
...
class Lh extends Ke {
    constructor(t, e, n) {
        ...
        let i = null,
            r = null;
        const s = [];
        (this.mode = "translate"), (this.rotateSpeed = 1);
        const a = this;
        function o() {
            n.addEventListener("pointermove", c),
                n.addEventListener("pointerdown", h),
                n.addEventListener("pointerup", u),
                n.addEventListener("pointerleave", u);
        }
        function l() {
            n.removeEventListener("pointermove", c),
                n.removeEventListener("pointerdown", h),
                n.removeEventListener("pointerup", u),
                n.removeEventListener("pointerleave", u),
                (n.style.cursor = "");
        }
        function c(o) {
            if (!1 !== a.enabled) {
                if ((d(o), vh.setFromCamera(yh, e), i))
                    "translate" === a.mode
                        ? vh.ray.intersectPlane(gh, wh) && i.position.copy(wh.sub(xh).applyMatrix4(Sh))
                        : "rotate" === a.mode &&
                          (_h.subVectors(yh, bh).multiplyScalar(a.rotateSpeed),
                          i.rotateOnWorldAxis(Eh, _h.x),
                          i.rotateOnWorldAxis(Th.normalize(), -_h.y)),
                        a.dispatchEvent({type: "drag", object: i}),
                        bh.copy(yh);
                else if ("mouse" === o.pointerType || "pen" === o.pointerType)
                    if (((s.length = 0), vh.setFromCamera(yh, e), vh.intersectObjects(t, a.recursive, s), s.length > 0)) {
                        const t = s[0].object;
                        gh.setFromNormalAndCoplanarPoint(e.getWorldDirection(gh.normal), Mh.setFromMatrixPosition(t.matrixWorld)),
                            r !== t && null !== r && (a.dispatchEvent({type: "hoveroff", object: r}), (n.style.cursor = "auto"), (r = null)),
                            r !== t && (a.dispatchEvent({type: "hoveron", object: t}), (n.style.cursor = "pointer"), (r = t));
                    } else null !== r && (a.dispatchEvent({type: "hoveroff", object: r}), (n.style.cursor = "auto"), (r = null));
                bh.copy(yh);
            }
        }
        function h(r) {
            !1 !== a.enabled &&
                (d(r),
                (s.length = 0),
                vh.setFromCamera(yh, e),
                vh.intersectObjects(t, a.recursive, s),
                s.length > 0 &&
                    ((i = !0 === a.transformGroup ? p(s[0].object) : s[0].object),
                    gh.setFromNormalAndCoplanarPoint(e.getWorldDirection(gh.normal), Mh.setFromMatrixPosition(i.matrixWorld)),
                    vh.ray.intersectPlane(gh, wh) &&
                        ("translate" === a.mode
                            ? (Sh.copy(i.parent.matrixWorld).invert(), xh.copy(wh).sub(Mh.setFromMatrixPosition(i.matrixWorld)))
                            : "rotate" === a.mode &&
                              (Eh.set(0, 1, 0).applyQuaternion(e.quaternion).normalize(), Th.set(1, 0, 0).applyQuaternion(e.quaternion).normalize())),
                    (n.style.cursor = "move"),
                    a.dispatchEvent({type: "dragstart", object: i})),
                bh.copy(yh));
        }
        function u() {
            !1 !== a.enabled && (i && (a.dispatchEvent({type: "dragend", object: i}), (i = null)), (n.style.cursor = r ? "pointer" : "auto"));
        }
        function d(t) {
            const e = n.getBoundingClientRect();
            (yh.x = ((t.clientX - e.left) / e.width) * 2 - 1), (yh.y = (-(t.clientY - e.top) / e.height) * 2 + 1);
        }
        function p(t, e = null) {
            return t.isGroup && (e = t), null === t.parent ? e : p(t.parent, e);
        }
        o(),
            (this.enabled = !0),
            (this.recursive = !0),
...
class Ah extends Qa {
    ...
    _init(t) {
        (this.camera = new Nr(75, window.innerWidth / window.innerHeight, 0.1, 1e3)),
            ...
            this.renderer.setClearColor(11128035, 1),
            t || (this.background = new zi(11128035)),
            (this.orbitControls = new fh(this.camera, this.renderer.domElement)),
    ...
    _initializeDragControls(t) {
        (this.dragControls = new Lh(t, this.camera, this.renderer.domElement)),
            this.dragControls.addEventListener("dragstart", function (t) {
                t.object.material.color.set(16711680);
            }),
            this.dragControls.addEventListener("dragend", function (t) {
                const e = "#" + t.object.material.originalColor;
                t.object.material.color.set(e);
            });
        const e = this.orbitControls;
    ...
    addCompartment(t) {
        const e = t.length,
            ...
            a = t.zpos,
            o = new Er(n, i, e),
            l = new Hi({color: `#${Math.floor(16777215 * Math.random()).toString(16)}`});
        l.originalColor = l.color.getHexString();
        const c = new Mr(o, l);
        c.rotation.set(Math.PI / 2, Math.PI / 2, 0), c.position.set(r, s, a), this.compartment_mesh.push(c), this.addToScene(c);
    }
    addAxesHelper(t = 10) {
        const e = new uh(10);
        this.addToScene(e);
...
class Rh extends Mr {
    constructor({length: t = 10, width: e = 10, height: n = 10, xpos: i = 0, ypos: r = 0, zpos: s = 0, type: a = "compartment"} = {}) {
        return {length: t, width: e, height: n, xpos: i, ypos: r, zpos: s, type: a};
    }
}
class Ch extends qa {
    constructor(t, e) {
        if ((super(), null == t)) {
            t = {};
            const e = this.wigley_formula();
            (this.halfBreadths = {waterlines: e.waterlines, stations: e.stations, table: e.table}),
                (this.attributes = {LOA: 20, BOA: 10, Depth: 4, APP: 0}),
                (this.style = {upperColor: "yellow", lowerColor: "green", opacity: 0.5});
        } else Object.assign(this, t);
        (this.bulkheads = void 0),
            (this.group = "Hull3D"),
            (this.name = "Hull3D"),
            (this.design_draft = void 0 !== e ? e : 0.5 * this.attributes.Depth),
            (this.upperColor = void 0 !== this.style.upperColor ? this.style.upperColor : 3385907),
            (this.lowerColor = void 0 !== this.style.lowerColor ? this.style.lowerColor : 11154227),
            (this.opacity = void 0 !== this.style.opacity ? this.style.opacity : 0.5),
            this.update();
    }
    addStation(e) {
        const n = this.halfBreadths,
            {index: i, mu: r} = t(n.stations, e);
        n.stations.splice(i, 0, e);
        for (let t = 0; t < n.waterlines.length; t++) n.table[t].splice(i, 0, 0);
        this.update();
    }
    addWaterline(e) {
        const n = this.halfBreadths,
            {index: i, mu: r} = t(n.waterlines, e);
        n.waterlines.splice(i, 0, e), n.table.splice(i, 0, new Array(n.stations.length).fill(0)), this.update();
    }
    getWaterline(n) {
        let i = this.attributes,
            r = n / i.Depth,
            s = this.halfBreadths.waterlines,
            a = this.halfBreadths.stations,
            o = this.halfBreadths.table;
        if (r < s[0]) return new Array(a.length).fill(0);
        {
            let n, l;
            r > s[s.length - 1]
                ? ((n = s.length - 2), (l = 1))
                : (({index: n, mu: l} = t(s, r)), n === s.length - 1 && ((n = s.length - 2), (l = 1)));
            let c = new Array(a.length);
            for (let t = 0; t < c.length; t++) {
                let r,
                    a,
                    h = n;
                if (null === o[h][t] || isNaN(o[h][t])) {
                    for (h = n + 1; h < s.length && (isNaN(o[h][t]) || null === o[h][t]); ) h++;
                    if (h !== s.length) r = 0;
                    else {
                        for (h = n - 1; h >= 0 && (isNaN(o[h][t]) || null === o[h][t]); ) h--;
                        -1 === h ? ((r = 0), (a = 0)) : ((r = o[h][t]), (a = r));
                    }
                } else r = o[h][t];
                let u = n + 1;
                if (void 0 !== a);
                else if (null === o[u][t] || isNaN(o[u][t])) {
                    for (u = n + 2; u < s.length && (isNaN(o[u][t]) || null === o[u][t]); ) u++;
                    a = u === s.length ? r : o[u][t];
                } else a = o[u][t];
                (c[t] = e(r, a, l)), null === c[t] || isNaN(c[t]) || (c[t] *= 0.5 * i.BOA);
            }
            return c;
        }
    }
    getStation(n) {
        let i,
            ...
            s = n / r.LOA,
            a = this.halfBreadths.stations,
            o = this.halfBreadths.waterlines,
            l = this.halfBreadths.table,
            {index: c, mu: h} = t(a, s);
        if (c < 0 || c >= a.length) i = new Array(o.length).fill(null);
        else if (c + 1 === a.length) i = l.map(t => t[a.length - 1]);
        else {
            i = [];
            for (let t = 0; t < o.length; t++) {
                let n = l[t][c],
                    r = l[t][c + 1];
                (null !== n && !isNaN(n)) || (null !== r && !isNaN(r)) ? i.push(e(n || 0, r || 0, h)) : i.push(null);
            }
        }
        for (let t = 0; t < this.halfBreadths.waterlines.length; t++) (i[t] *= 0.5 * r.BOA), (isNaN(i[t]) || null === i[t]) && (i[t] = null);
        return i;
    }
    update() {
        const {upperColor: t, lowerColor: e, design_draft: n, opacity: i} = this,
            {
                attributes: {LOA: r, BOA: s, Depth: a},
                halfBreadths: {stations: o, waterlines: l, table: c},
            } = this;
        this.hullGeometry && this.hullGeometry.dispose(), (this.hullGeometry = new Ph(o, l, c));
        let h = o.length,
            u = l.length,
            d = this.getStation(r).map(t => t / (0.5 * s));
        this.bowCapG && this.bowCapG.dispose(), (this.bowCapG = new Wr(void 0, void 0, 1, u - 1));
        let p = this.bowCapG.getAttribute("position"),
            f = p.array;
        for (let t = 0; t < u; t++)
            (f[2 * t * 3] = 1),
                (f[2 * t * 3 + 1] = d[t]),
                ...
                (f[3 * (2 * t + 1) + 2] = l[t]);
        p.needsUpdate = !0;
        let m = this.getStation(0).map(t => t / (0.5 * s));
        this.aftCapG && this.aftCapG.dispose(),
            (this.aftCapG = new Wr(void 0, void 0, 1, u - 1)),
            (p = this.aftCapG.getAttribute("position")),
            (f = p.array);
        for (let t = 0; t < u; t++)
            (f[2 * t * 3] = 0),
                (f[2 * t * 3 + 1] = -m[t]),
                ...
                (f[3 * (2 * t + 1) + 2] = l[t]);
        p.needsUpdate = !0;
        let g = this.getWaterline(0).map(t => t / (0.5 * s));
        this.bottomCapG && this.bottomCapG.dispose(),
            (this.bottomCapG = new Wr(void 0, void 0, h - 1, 1)),
            (p = this.bottomCapG.getAttribute("position")),
            (f = p.array);
        for (let t = 0; t < h; t++)
            (f[3 * t] = o[t]),
                (f[3 * t + 1] = -g[t]),
                ...
                (f[3 * (h + t) + 1] = g[t]),
                (f[3 * (h + t) + 2] = 0);
        if (((p.needsUpdate = !0), !this.hMat)) {
            let t = Xr.phong,
                e = "uniform float wlThreshold;uniform vec3 aboveWL; uniform vec3 belowWL;\nvarying float vZ;";
            this.hMat = new Pr({
                uniforms: Ar.merge([t.uniforms, {wlThreshold: new $c(0.5), aboveWL: new $c(new zi()), belowWL: new $c(new zi())}]),
                vertexShader: e + t.vertexShader.replace("main() {", "main() {\nvZ = position.z;").replace("#define PHONG", ""),
                fragmentShader:
                    e +
                    t.fragmentShader
                        .replace(
        ...
        (this.hMat.uniforms.wlThreshold.value = this.design_draft / a),
            (this.hMat.uniforms.aboveWL.value = new zi(t)),
            (this.hMat.uniforms.belowWL.value = new zi(e)),
            (this.hMat.uniforms.opacity.value = i),
            this.port && this.remove(this.port),
            (this.port = new Mr(this.hullGeometry, this.hMat)),
            (this.port.name = "HullPortSide"),
            this.starboard && this.remove(this.starboard),
            (this.starboard = new Mr(this.hullGeometry, this.hMat)),
            (this.starboard.name = "HullStarboardSide"),
            (this.starboard.scale.y = -1),
            this.add(this.port, this.starboard),
            this.bowCap && this.remove(this.bowCap),
            (this.bowCap = new Mr(this.bowCapG, this.hMat)),
            this.aftCap && this.remove(this.aftCap),
            (this.aftCap = new Mr(this.aftCapG, this.hMat)),
            this.bottomCap && this.remove(this.bottomCap),
            (this.bottomCap = new Mr(this.bottomCapG, this.hMat)),
            this.add(this.bowCap, this.aftCap, this.bottomCap),
            this.scale.set(r, 0.5 * s, a);
    }
    addBulkheads(t, e, n, i) {
        if (null == this.bulkheads) {
            let e = t.BOA,
                n = t.Depth;
            (this.bulkheads = new qa()), this.bulkheads.scale.set(1, 0.5 * e, n);
        }
        (this.bulkHeadGeometry = new Er(1, 1, 1)),
            this.bulkHeadGeometry.translate(0, 0, 0.5),
            new Ll({color: 13421772, transparent: !0, opacity: 0.5, side: v}),
            bulkHeadGeometry.translate(0.5, 0, 0),
            ship.structure.bulkheads;
    }
    wigley_formula() {
        const t = {waterlines: [], stations: [], table: []};
        for (let e = 0; e <= 20; e++) {
            const n = e / 20;
            t.waterlines.push(n);
            const i = [];
            for (let t = 0; t <= 40; t++) {
                const e = (1 - (2 * (t / 40 - 0.5)) ** 2) * (1 - (n - 1) ** 2);
                i.push(e);
            }
            t.table.push(i);
        }
        return (t.stations = Array.from({length: 41}, (t, e) => e / 40)), t;
    }
}
class Ph extends Wr {
    constructor(t, e, n) {
        const i = t.length,
            r = e.length;
        super(void 0, void 0, i - 1, r - 1), (this.stations = t), (this.waterlines = e), (this.table = n), (this.N = i), (this.M = r), this.update();
    }
    update() {
        ...
        let r = 0;
        for (let t = 0; t < i; t++)
            for (let i = 0; i < n; i++) (e[r] = this.stations[i]), (e[r + 1] = this.table[t][i]), (e[r + 2] = this.waterlines[t]), (r += 3);
        let s = this.getAttribute("uv"),
            a = s.array;
        for (let t = 0; t < n; t++) {
            let r, s, o;
            for (o = 0; o < i; o++) {
                if (null !== this.table[o][t]) {
                    (r = o), (s = o);
                    let i = r * n + t,
                        l = e[3 * i],
                        c = e[3 * i + 1],
                        ...
                        u = i;
                    for (; r > 0; )
                        r--, (u -= n), (e[3 * u] = l), (e[3 * u + 1] = c), (e[3 * u + 2] = h), (a[2 * u] = a[2 * i]), (a[2 * u + 1] = a[2 * i + 1]);
                    break;
                }
            }
            for (; o < i; o++) {
                if (null === this.table[o][t]) break;
                s = o;
            }
            let l = s * n + t,
                c = e[3 * l],
                ...
                d = l;
            for (; s < i - 1; )
                s++, (d += n), (e[3 * d] = c), (e[3 * d + 1] = h), (e[3 * d + 2] = u), (a[2 * d] = a[2 * l]), (a[2 * d + 1] = a[2 * l + 1]);
        }
        (t.needsUpdate = !0), (s.needsUpdate = !0), this.computeVertexNormals();
    }
}
function Dh(t) {
...
function Ih(t, e) {
    const n = t.length;
    (t[n - 1] = 0.5 * t[n - 1]), (t[0] = 0.5 * t[0]);
    const i = Dh(t);
    return t.reduce((t, n, i) => t + n * e[i], 0) / i;
}
function Oh(t, e) {
    const n = t.length - 1;
    if (n < 1) throw new Error("At least two data points are required.");
    if (n != e.length - 1) throw new Error("x and y must be from the same size");
    if (1 === n) {
        return ((t[1] - t[0]) * (e[0] + e[1])) / 2;
    }
    let i = [];
    for (let e = 0; e < n; e++) i.push(t[e + 1] - t[e]);
    let r = 0;
    for (let t = 1; t < n; t += 2) {
        let n = i[t - 1],
            s = i[t];
        ...
        let a = s + n,
            o = s / n,
            l = s * n;
        r += (a / 6) * ((2 - o) * e[t - 1] + (a ** 2 / l) * e[t] + (2 - 1 / o) * e[t + 1]);
    }
    if (n % 2 == 1) {
        let t = i[n - 2],
            s = i[n - 1];
        0 !== t &&
            0 !== s &&
            ((r += (e[n] * (2 * s ** 2 + 3 * t * s)) / (6 * (t + s))),
            (r += (e[n - 1] * (s ** 2 + 3 * s * t)) / (6 * t)),
            (r -= (e[n - 2] * s ** 3) / (6 * t * (t + s))));
    }
    return r;
}
class zh {
    constructor(t, e) {
        if (e > t.attributes.Depth) throw new Error("Design draft is bigger than the depth which is realistically impossible.");
        const n = e / t.attributes.Depth,
            {x: i, z: r, submerged_table: s, waterline_row: a} = this.interpolateWaterline(t, n);
        Object.assign(this, this.computeHydrostatics(i, r, s, a));
    }
    interpolateWaterline(t, e = 1) {
        const n = t.halfBreadths.waterlines,
            i = t.halfBreadths.stations,
            r = t.halfBreadths.table,
            s = t.attributes.LOA,
            a = t.attributes.Depth,
            o = t.attributes.BOA / 2,
            {submergedWaterLines: l, submergedTables: c, interpolatedTableLine: h} = this.takeSubmergedTables(n, r, e),
            u = c.map(t => Nh(t, o)),
            d = Nh(h, o);
        return {x: Nh(i, s), z: Nh(l, a), submerged_table: u, waterline_row: d};
    }
    takeSubmergedTables(n, i, r) {
        if (1 === r) {
            return {index: n.length - 1, mu: 0, submergedWaterLines: n, submergedTables: i};
        }
        const {index: s, mu: a} = t(n, r),
            o = n.slice(0, s + 1),
            l = i.slice(0, o.length),
            c = i[s],
            h = i[s + 1],
            u = c.map((t, n) => e(t, h[n], a));
        return l.push(u), o.push(r), {index: s, mu: a, submergedWaterLines: o, submergedTables: l, interpolatedTableLine: u};
    }
    computeHydrostatics(t, e, n, i) {
        const r = n[0].map((t, i) => {
                const r = n.map(t => t[i]);
                return 2 * Oh(e, r);
            }),
            ...
            c = Ih(r, t),
            {
                ...
                const n = t.length;
                if (n < 2) throw new Error("At least two data points are required.");
                let i = t[1] - t[0],
                    r = Array(n).fill(1);
                r[0] = r[n - 1] = 0.5;
                let s = [],
                ...
                for (let i = 0; i < n; i++) {
                    const n = r[i] * e[i],
                        ...
                        h = c * t[i],
                        u = r[i] * e[i] * e[i] * e[i];
                    s.push(n), a.push(c), o.push(h), l.push(u);
                }
                const c = Dh(s),
                    h = 2 * i * c,
                    u = Dh(a) / c,
                    d = 2 * Dh(o) * i;
                return {AWL: h, LCF: u, IT: (2 / 3) * Dh(l) * i, Iy: d, IL: d - Math.pow(u, 2) * h};
            })(t, i);
        return {volume: a, disp: o, KB: l, LCB: c, AWL: h, LCF: u, IT: d, Iy: p, IL: f, TPC: (1.025 * h) / 100, BM: d / a};
    }
}
class Hh {
    constructor(t) {
    ...
    addHull(t) {
        if (!t.hasOwnProperty("design_draft") || "number" != typeof t.design_draft)
            throw new Error("The attribute 'design_draft' is either missing or not a numerical value.");
        this.hull = new Ch(t, t.design_draft);
    }
    initializeHydrostatics() {
        if (!this.hull) throw new Error("Hydrostatics only available after hull definition. Use addHull method");
        this.HullHydrostatics = new zh(this.hull, this.hull.design_draft);
    }
    addBulkhead(t, e, n) {
        try {
            if (void 0 === this.hull) throw new Error("The key 'hull' is not defined in the object. Use the addHull function to insert a hull first");
        } catch (t) {
            throw new Error("The key 'hull' is not defined in the object.");
        }
        this.hull.addBulkheads(this.hull.attributes, t, e, n);
    }
    addCompartments(t) {
        const e = new Rh(t);
        this.compartments.push(e);
    }
    initializeDragControls() {
        this.scene._initializeDragControls(this.compartments);
    }
}
const Bh = {bisectionSearch: t};
"undefined" != typeof window &&
    (window.__VESSEL__ ? console.warn("WARNING: Multiple instances of Vessel.js being imported.") : (window.__VESSEL__ = "v0.0.1-alpha"));
export {zh as HullHydrostatics, Ah as Scene, Hh as Ship, Bh as math};
